    ...
    <vx-card title="Street View" code-toggler>
        ...
        <div class="mt-5">
            ...
            <div class="demo-alignment">
                <vs-button type="filled" class="rounded-lg" @click="pov.heading = Math.random() * 360">Change Heading</vs-button>
                <vs-button type="filled" class="rounded-lg" @click="pov.pitch = Math.random() * 180 - 90">Change Pitch</vs-button>
                <vs-button type="filled" class="rounded-lg" @click="pov.pitch = Math.random() * 180 - 90, pov.heading = Math.random() * 360">Change Both</vs-button>
            </div>
        </div>
