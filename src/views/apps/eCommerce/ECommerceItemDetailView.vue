              ...
              <div class="vx-col md:w-3/5 w-full">
                ...
                <div class="vx-row">
                  <div class="vx-col flex flex-wrap items-center">
                    <vs-button class="rounded-lg mr-4" type="border" icon-pack="feather" color="#1551b1" icon="icon-facebook" radius></vs-button>
                    <vs-button class="rounded-lg mr-4" type="border" icon-pack="feather" color="#00aaff" icon="icon-twitter" radius></vs-button>
                    <vs-button class="rounded-lg mr-4" type="border" icon-pack="feather" color="#c4302b" icon="icon-youtube" radius></vs-button>
                    <vs-button class="rounded-lg mr-4" type="border" icon-pack="feather" color="#405DE6" icon="icon-instagram" radius></vs-button>
                  </div>
                </div>
