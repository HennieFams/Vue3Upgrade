        ...
        <form-wizard
            ...
            <tab-content title="Cart" icon="feather icon-shopping-cart" class="mb-5">
                ...
                <div class="vx-row" v-if="cartItems.length">
                    ...
                    <div class="vx-col lg:w-1/3 w-full">
                        <vx-card>
                            ...
                            <vs-button class="rounded-lg w-full" @click="$refs.checkoutWizard.nextTab()">PLACE ORDER</vs-button>
                        </vx-card>
                    </div>
                </div>
                ...
                <vx-card title="You don't have any items in your cart." v-else>
                    <vs-button class="rounded-lg " @click="$router.push('/apps/eCommerce/shop').catch(() => {})">Browse Shop</vs-button>
                </vx-card>
                ...
                <div class="vx-row">
                            ...
                            <form data-vv-scope="add-new-address">
                                ...
                                <div class="vx-row">
                                    ...
                                    <div class="vx-col sm:w-1/2 w-full">
                                      ...
                                      <vs-button class="rounded-lg mt-6 ml-auto flex" @click.prevent="submitNewAddressForm">SAVE AND DELIVER HERE</vs-button>
                            </form>
                        </vx-card>
                    </div>
                    ...
                    <div class="vx-col lg:w-1/3 w-full">
                        <vx-card title="John Doe">
                            ...
                            <vs-button class="rounded-lg w-full" @click="$refs.checkoutWizard.nextTab()">DELIVER TO THIS ADDRESS</vs-button>
                        </vx-card>
                    </div>
                                  ...
                                  <li>
                                    ...
                                    <form data-vv-scope="cvv-form">
                                        <div class="flex items-center flex-wrap">
                                            ...
                                            <vs-button class="rounded-lg mt-4" @click.prevent="makePayment" :disabled="false">CONTINUE</vs-button>
                                        </div>
