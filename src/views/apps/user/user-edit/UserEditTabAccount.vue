      ...
      <div class="vx-col w-full">
        <div class="flex items-start flex-col sm:flex-row">
          ...
          <div>
            ...
            <vs-button class="rounded-lg mr-4 mb-4">Change Avatar</vs-button>
            <!-- <vs-button type="border" class="rounded-lg mr-4" @click="$refs.update_avatar_input.click()">Change Avatar</vs-button> -->

            <vs-button class="rounded-lg" type="border" color="danger">Remove Avatar</vs-button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="vx-row">
      <div class="vx-col w-full">
        <div class="mt-8 flex flex-wrap items-center justify-end">
          <vs-button class="rounded-lg ml-auto mt-2" @click="save_changes" :disabled="!validateForm">Save Changes</vs-button>
          <vs-button class="rounded-lg ml-4 mt-2" type="border" color="warning" @click="reset_data">Reset</vs-button>
        </div>
      </div>
    </div>
  </div>
