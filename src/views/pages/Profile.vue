            ...
            <div class="relative">
                ...
                <div class="profile-img-container pointer-events-none">
                    ...
                    <div class="profile-actions pointer-events-auto flex">
                        <vs-button class="rounded-lg " icon-pack="feather" radius icon="icon-edit-2"></vs-button>
                        <vs-button icon-pack="feather" radius icon="icon-settings" class="rounded-lg ml-2 lg:ml-4"></vs-button>
                    </div>
                </div>
            </div>
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div class="post-comment">
                                ...
                                <vs-button class="rounded-lg " size="small">Post Comment</vs-button>
                            </div>
                        </div>
                    </div>
                </vx-card>
                    ...
                    <ul class="friend-suggesions-list">
                        <li class="friend-suggestion flex items-center mb-4" v-for="(friend, index) in suggestedFriends" :key="index">
                            ...
                            <div class="ml-auto cursor-pointer">
                                <vs-button class="rounded-lg " radius type="border" icon-pack="feather" icon="icon-user-plus" />
                            </div>
                        </li>
                    </ul>
                    <template slot="footer">
                    <vs-button icon-pack="feather" icon="icon-plus" class="rounded-lg w-full">Load More</vs-button>
                    </template>
                </vx-card>
                ...
                <vx-card title="Polls" class="mt-base">
                    <ul class="polls-list">
                        <li class="poll" v-for="poll in polls" :key="poll.id">
                            ...
                            <vs-button class="rounded-lg mt-5 w-full">Vote Now</vs-button>
                        </li>
                    </ul>
                </vx-card>
            </div>
        ...
        <div class="vx-row">
            <div class="vx-col w-full">
                <div class="flex justify-center mt-base">
                    <vs-button id="button-load-more-posts" class="rounded-lg vs-con-loading__container" @click="loadContent">Load More</vs-button>
                </div>
            </div>
        </div>
    </div>
