<template>
  <vx-card no-shadow>
    ...
    <div class="flex flex-wrap items-center mb-base">
      ...
      <div>
        <vs-button class="rounded-lg mr-4 sm:mb-0 mb-2">Upload photo</vs-button>
        <vs-button class="rounded-lg " type="border" color="danger">Remove</vs-button>
    ...
    <div class="flex flex-wrap items-center justify-end">
      <vs-button class="rounded-lg ml-auto mt-2">Save Changes</vs-button>
      <vs-button class="rounded-lg ml-4 mt-2" type="border" color="warning">Reset</vs-button>
    </div>
  </vx-card>
</template>
