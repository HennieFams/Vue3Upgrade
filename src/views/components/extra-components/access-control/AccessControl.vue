        ...
        <vx-card>
            ...
            <div class="demo-alignment mb-base">
             ...
             <vx-card title="Buttons" no-shadow card-border code-toggler>
                <vs-button v-show="$acl.check('editor')" class="rounded-lg mr-4 mb-2">Editor And Admin</vs-button>
                <vs-button v-show="$acl.check('admin')" class="rounded-lg ">Only Admin</vs-button>
...
&lt;/vs-collapse&gt;
            ...
            <vx-card title="Route Protection" no-shadow card-border code-toggler class="mt-base">
              ...
              <vs-button to="/dashboard/ecommerce" class="rounded-lg mt-4" :color="$acl.check('admin') ? 'primary' : 'danger'">visit</vs-button>
            </vx-card>
        </vx-card>
    </div>
</template>
