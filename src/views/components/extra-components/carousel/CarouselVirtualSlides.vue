...
<template>
    <vx-card title="Virtual Slides" class="carousel-example" code-toggler>
		<div class="mb-4">
			<vs-button class="rounded-lg mr-4 mb-4" @click.native="toSlide(0)">To Slide 1</vs-button>
			<vs-button class="rounded-lg mr-4 mb-4" @click.native="toSlide(249)">To Slide 250</vs-button>
			<vs-button class="rounded-lg mr-4 mb-4" @click.native="toSlide(499)">To Slide 500</vs-button>
		</div>
        <!-- swiper -->
