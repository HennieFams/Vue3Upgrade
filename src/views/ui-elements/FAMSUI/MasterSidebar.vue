      ...
      <div>
        <div class="vx-row px-4 pt-2 pb-3">
          <div class="vx-col flex-1">
            <label>Master Equipment's Name</label>
            <vs-input
                icon-pack="feather"
                  icon="icon-phone"
  ...
  watch: {
    isSidebarActive(val) {
      ...
      if (Object.entries(this.data).length === 0) {
        ...
        this.formData.Id = this.data.masterEqpId;
        this.formData.accountId = this.data.accountId;
        this.formData.name = this.data.masterEqp;
        this.formData.min = this.data.masterEqpMin;
        this.formData.max = this.data.masterEqpMax;
      }
    }
  },
  computed: {
