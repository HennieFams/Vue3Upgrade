...
*/
(function (fn) {
    typeof define === 'function' && define.amd ? define(["./../common/ej.core","./../common/ej.data","./../common/ej.globalize","./../common/ej.touch","./../common/ej.scroller","./../web/ej.tooltip"], fn) : fn();
})
(function () {
...
(function ($, ej) {
    ...
    var HeatMapGrid = (function () {
        ...
        HeatMapGrid.prototype._createTemplateElement = function (column, appendTo /* container to append */, text) {
            ...
            appendTo.append(text ? $(scripEle).html() : scripEle); //if `text` then append innerHTML instead of element.
