...
*/
(function (fn) {
    typeof define === 'function' && define.amd ? define(["./../common/ej.core","./ej.radialslider"], fn) : fn();
})
(function () {
    ...
    ej.widget("ejRadialMenuBase", "ej.RadialMenuBase", {
        ...
        _createImageElement: function (width, height, currentEle, x, y) {
            if (!ej.isNullOrUndefined(currentEle["imageUrl"]) || !ej.isNullOrUndefined(currentEle["imagePath"])) {
                var imgLoc = currentEle["imageUrl"] ? currentEle["imageUrl"] : (this.model.renderMode.toLowerCase() != "flat" ? currentEle["imagePath"] + "/"
                ...
                var image = document.createElementNS(this._svgLink, "image");
