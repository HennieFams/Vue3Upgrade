...
*/
(function (fn) {
    typeof define === 'function' && define.amd ? define(["./../common/ej.globalize","./../common/ej.core","./../common/ej.data","./ej.waitingpopup","./ej.pivotgauge","./../datavisualization/ej.circulargauge","./ej.pivotanalysis.base","./ej.olap.base","./ej.pivot.common"], fn) : fn();
})
(function () {
    ...
    ej.widget("ejPivotGauge", "ej.PivotGauge", {
        ...
        _load: function () {
			...
			if ($("#" + this._id).parent()[0]) {
               ...
               $("#" + this._id).ejWaitingPopup({ showOnInit: true , appendTo: $("#" + this._id).parent()[0] });
		    }
                ...
                if (ogaugeInfo != null && ogaugeInfo.length > 0) {
                    if (this.rowsCount() < 1 && this.columnsCount() < 1) {
                        ...
                        for (var k = 0; k < ogaugeInfo.length; k++) {
                            statusImage = ej.buildTag("img#" + this._id + "_statusIndicator_" + k + ".kpiiconvalue")[0].outerHTML;
                            trendImage = ej.buildTag("img#" + this._id + "_trendIndicator_" + k + ".kpiiconvalue")[0].outerHTML;
                        ...
                        for (var i = 0; i < this.rowsCount() ; i++) {
                            ...
                            for (var j = 0; j < this.columnsCount() ; j++) {
                                statusImage = ej.buildTag("img#" + this._id + "_statusIndicator_" + gaugeId + ".kpiiconvalue")[0].outerHTML;
                                trendImage = ej.buildTag("img#" + this._id + "_trendIndicator_" + gaugeId + ".kpiiconvalue")[0].outerHTML;
        ...
        renderControlFromJSON: function (jsonObj) {
            ...
            for (var i = 0; i < maxGaugeCount; i++) {
                ...
                imgDiv = this.element.find("#" + this._id + "_statusIndicator_" + [i]).addClass(statusClass);
                ...
                if (jsonObj[i].TrendGraphic != null && jsonObj[i].TrendGraphic != undefined && jsonObj[i].TrendGraphic != "" && jsonObj[i].TrendGraphic.toLowerCase() == "standard arrow") {
                    ...
                    imgDiv = this.element.find("#" + this._id + "_trendIndicator_" + [i]).toggleClass(trendClass);
                }
