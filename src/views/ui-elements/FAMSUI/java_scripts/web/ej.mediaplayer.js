...
*/
(function (fn) {
    typeof define === 'function' && define.amd ? define(["./../common/ej.core","./../common/ej.data","./../common/ej.draggable","./../common/ej.scroller","./../common/ej.globalize","./ej.button","./ej.listbox","./ej.listview","./ej.togglebutton","./ej.slider"], fn) : fn();
})
(function () {
