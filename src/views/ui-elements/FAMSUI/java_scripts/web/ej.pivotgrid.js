    ...
    ej.widget("ejPivotGrid", "ej.PivotGrid", {
        ...
        _load: function () {
            ...
            if ($(this.element).parents(".e-pivotclient").length > 0) {
                ...
                if (ej.isNullOrUndefined(this._waitingPopup) && $("#" + this._id).parent()[0]) {
        ...
        _wireEvents: function () {
            ...
            this._on(this.element, "contextmenu", ".value,.rowheader,.colheader,.summary", ej.proxy(function (evt) {
                ...
                if (this.model.enableContextMenu && ej.isNullOrUndefined(this._pivotClientObj) && !this.model.enableCellContext) {
                    ...
                    layouts = this.model.analysisMode == ej.Pivot.AnalysisMode.Pivot ? "<li><a>" + this._getLocalizedLabels("Layouts") + "</a><ul><li id='" + this._id + "_normalLayout'><a>" + this._getLocalizedLabels("NormalLayout") + "</a><li><li id='" + this._id + "_excelLikeLayout'><a>" + this._getLocalizedLabels("ExcelLikeLayout") + "</a><li></ul></li>" : (this.model.analysisMode == ej.Pivot.AnalysisMode.Olap && this.model.operationalMode == ej.Pivot.OperationalMode.ClientMode ? "<li><a>" + this._getLocalizedLabels("Layouts") + "</a><ul><li id='" + this._id + "_normalLayout'><a>" + this._getLocalizedLabels("NormalLayout") + "</a><li><li id='" + this._id + "_excelLikeLayout'><a>" + this._getLocalizedLabels("ExcelLikeLayout") + "</a><li><li id='" + this._id + "_noSummariesLayout'><a>" + this._getLocalizedLabels("NoSummaries") + "</a><li></ul></li>" : "<li><a>" + this._getLocalizedLabels("Layouts") + "</a><ul><li id='" + this._id + "_normalLayout'><a>" + this._getLocalizedLabels("NormalLayout") + "</a><li><li id='" + this._id + "_excelLikeLayout'><a>" + this._getLocalizedLabels("ExcelLikeLayout") + "</a><li><li id='" + this._id + "_noSummariesLayout'><a>" + this._getLocalizedLabels("NoSummaries") + "</a><li><li id='" + this._id + "_normalTopSummaryLayout'><a>" + this._getLocalizedLabels("NormalTopSummary") + "</a><li></ul></li>");
                    ...
                    var hyperlink = "<li><a>" + this._getLocalizedLabels("HyperLink") + "</a><ul><li id='" + this._id + "_rowHeader'><a>" + this._getLocalizedLabels("EnableRowHeaderHyperlink") + "</a></li><li id='" + this._id + "_columnHeader'><a>" + this._getLocalizedLabels("EnableColumnHeaderHyperlink") + "</a></li><li id='" + this._id + "_valueCell'><a>" + this._getLocalizedLabels("EnableValueCellHyperlink") + "</a></li><li id='" + this._id + "_summaryCell'><a>" + this._getLocalizedLabels("EnableSummaryCellHyperlink") + "</a></li></ul></li>";
                    var exporting = "<li><a>" + this._getLocalizedLabels("Exporting") + "</a><ul><li id='" + this._id + "_excel'><a>" + this._getLocalizedLabels("Excel") + "</a></li><li id='" + this._id + "_word'><a>" + this._getLocalizedLabels("Word") + "</a></li><li id='" + this._id + "_pdf'><a>" + this._getLocalizedLabels("PDF") + "</a></li><li id='" + this._id + "_csv'><a>" + this._getLocalizedLabels("CSV") + "</a></li></ul></li>";
                    var frozen = "<li class='e-separator'><a>" + this._getLocalizedLabels("FrozenHeader") + "</a><ul><li id='" + this._id + "_row'><a>" + this._getLocalizedLabels("Row") + "</a></li><li id='" + this._id + "_column'><a>" + this._getLocalizedLabels("Column") + "</a></li></ul></li>";
        ...
        _stateMaintenance: function () {
            ...
            if (this.model.frozenHeaderSettings.enableFrozenRowHeaders)
                $("li#" + this._id + "_row a:eq(0)").append(enabledState);
            if (this.model.frozenHeaderSettings.enableFrozenColumnHeaders)
                $("li#" + this._id + "_column a:eq(0)").append(enabledState);
            if (this.model.hyperlinkSettings.enableRowHeaderHyperlink)
                $("li#" + this._id + "_rowHeader a:eq(0)").append(enabledState);
            if (this.model.hyperlinkSettings.enableColumnHeaderHyperlink)
               $("li#" + this._id + "_columnHeader a:eq(0)").append(enabledState);
            if (this.model.hyperlinkSettings.enableValueCellHyperlink)
               $("li#" + this._id + "_valueCell a:eq(0)").append(enabledState);
            if (this.model.hyperlinkSettings.enableSummaryCellHyperlink)
                $("li#" + this._id + "_summaryCell a:eq(0)").append(enabledState);
            if (this.model.layout==ej.PivotGrid.Layout.Normal)
                $("li#" + this._id + "_normalLayout a:eq(0)").append(enabledState);
            if (this.model.layout == ej.PivotGrid.Layout.NoSummaries)
                $("li#" + this._id + "_noSummariesLayout a:eq(0)").append(enabledState);
            if (this.model.layout == ej.PivotGrid.Layout.ExcelLikeLayout)
                $("li#" + this._id + "_excelLikeLayout a:eq(0)").append(enabledState);
            if (this.model.layout == ej.PivotGrid.Layout.NormalTopSummary)
                $("li#" + this._id + "_normalTopSummaryLayout a:eq(0)").append(enabledState);
        ...
        _contextMenuClick: function (evt) {
            ...
            if ($(evt.element).hasClass("e-drillThrough") || $(evt.target).hasClass("e-drillThrough")) {
                if (this.model.analysisMode == ej.Pivot.AnalysisMode.Olap) {
                    ...
                    var ejDialog = ej.buildTag("div#" + this._id + "_clientDialog.e-clientDialog", { "opacity": "1" }).attr("title", dialogTitle)[0].outerHTML;
        ...
        _createMenuIcons: function (evt) {
            if ($(evt.target).hasClass("e-exporting")) {
                var exportDlg = ej.buildTag("div.e-exportDialog#" + this._id + "_exportDialog", ej.buildTag("table", ej.buildTag("tbody", ej.buildTag("tr",
            ...
            if ($(evt.target).hasClass("e-hyperlinkOptions")) {
                var hyperLinkDlg = ej.buildTag("div.e-hyperLinkDialog#" + this._id + "_hyperLinkTypesDialog", ej.buildTag("table", ej.buildTag("tbody", ej.buildTag("tr",
            ...
            if ($(evt.target).hasClass("e-frozenHeaders")) {
                var frozenDlg = ej.buildTag("div.e-frozenDialog#" + this._id + "_frozenDialog", ej.buildTag("table", ej.buildTag("tbody", ej.buildTag("tr",
            ...
            if ($(evt.target).hasClass("e-layouts")) {
                var layoutsDialog = ej.buildTag("div.e-layoutsDialog#" + this._id + "_layoutsDialog", ej.buildTag("table", ej.buildTag("tbody", ej.buildTag("tr",
        ...
        _createMenuDialog: function (evt) {
            ...
            var ejDialog = ej.buildTag("div#" + this._id + "_clientDialog.e-clientDialog", { "opacity": "1" })[0].outerHTML;
            ...
            if ($(evt.target).hasClass("e-numberFormatting") || $(evt.element).hasClass("e-numberFormatting")) {
                ...
                var measureList = "<select id='" + this._id + "_measureOption'>";
                for (var i = 0; i < this.model.dataSource.values.length; i++) {
                ...
                var numberformatting = "<div class='summarTypes'><select id='" + this._id + "_numberFormatOption'><option value='Decimal'>Decimal</option><option value='Currency'>Currency</option><option value='Percentage'>Percentage</option><option value='Number'>Number</option><option value='Date'>Date</option><option value='Time'>Time</option><option value='Scientific'>Scientific</option><option value='Fraction'>Fraction</option></select></div>";
                dialogContent = ej.buildTag("div#" + this._id + "_reportDlg.e-reportDlg", "<table><tr><td>" + measure + "</td><td>" + measureList + "</td></tr><tr><td>" + format + "</td><td>" + numberformatting + "</td></tr></table>")[0].outerHTML;
            }
            if ($(evt.target).hasClass("e-summaryCustomize") || $(evt.element).hasClass("e-summaryCustomize")) {
                ...
                var measureList = "<div class='measures'><select id='" + this._id + "_hideSubTotal'>";
                if (this.model.operationalMode == ej.PivotGrid.OperationalMode.ClientMode) {
                    for (var i = 0; i < this.model.dataSource.columns.length; i++) {
                ...
                measureList += "</div>";
                var rowGrndRadio = ej.buildTag("input#" + this._id + "_rowSumCheckBox.rowSumCheckBox", "", {}, { name: 'row', type: 'checkbox', tabindex: 0 })[0].outerHTML + " " + ej.buildTag("label.rowGrndlabel", this._getLocalizedLabels("Row"))[0].outerHTML + "<br/>";
                var colGrndRadio = ej.buildTag("input#" + this._id + "_colSumCheckBox.colSumCheckBox", "", {}, { name: 'column', type: 'checkbox', tabindex: 0 })[0].outerHTML + " " + ej.buildTag("label.colGrndlabel", this._getLocalizedLabels("Column"))[0].outerHTML + "<br/>";
                var bothGrndRadio = ej.buildTag("input#" + this._id + "_bothSumCheckBox.bothSumCheckBox", "", {}, { name: 'both', type: 'checkbox', tabindex: 0 })[0].outerHTML + " " + ej.buildTag("label.bothGrndlabel", this._getLocalizedLabels("Both"))[0].outerHTML + "<br/>";
                if (this.model.analysisMode == "pivot")
                    dialogContent = ej.buildTag("div#" + this._id + "_customizeDlg.customizeDlg", "<table><tr><td style='vertical-align:top'>" + label1 + "</td><td>" + rowGrndRadio + colGrndRadio + bothGrndRadio + "</td></tr><tr><td>" + label2 + "</td><td>" + measureList + "</td></tr></table>")[0].outerHTML;
                else
                    dialogContent = ej.buildTag("div#" + this._id + "_customizeDlg.customizeDlg", "<table><tr><td>" + label1 + "</td><td>" + rowGrndRadio + colGrndRadio + bothGrndRadio + "</td></tr></table>")[0].outerHTML;
            }
            if ($(evt.target).hasClass("e-summaryTypes") || $(evt.element).hasClass("e-summaryTypes")) {
                ...
                if (this.model.operationalMode == ej.PivotGrid.OperationalMode.ClientMode) {
                    var measureList = "<div class='measures'><select id='" + this._id + "_drillMeasure'>";
                    for (var i = 0; i < this.model.dataSource.values.length; i++) {
                ...
                var drpdown2 = ej.buildTag("input#" + this._id + "_drillSum").attr("type", "text")[0].outerHTML;
                dialogContent = ej.buildTag("div#" + this._id + "_summaryDlg.#" + this._id + "_summaryDlg", "<table><tr><td>" + label1 + "</td><td>" + measureList + "</td></tr><tr><td>" + label2 + "</td><td>" + drpdown2 + "</td></tr></table>")[0].outerHTML;
            }
            var EditorDiv = ej.buildTag("div#" + this._id + "_EditorDiv.e-editorDiv", "", { "margin-left": "5px" })[0].outerHTML;
            dialogContent += EditorDiv;
            var okBtn = "<button id=" + this._id + "_OKBtn class='e-dialogOkBtn'>" + this._getLocalizedLabels("OK") + "</button>";
            var cancelBtn = "<button id=" + this._id + "_CancelBtn class='e-dialogCancelBtn'>" + this._getLocalizedLabels("Cancel") + "</button>";
            ...
            if (this._selectedFormat == "" && this._selectedMeasure == "") {
                $("#" + this._id + "_numberFormatOption").ejDropDownList({ enableRTL: this.model.enableRTL, selectedIndex: 0, create: function () { $(this.wrapper.find('.e-input')).focus(function () { $(this).blur(); }) } });
                $("#" + this._id + "_measureOption").ejDropDownList({ enableRTL: this.model.enableRTL, selectedIndex: 0, showCheckbox: true, create: function () { $(this.wrapper.find('.e-input')).focus(function () { $(this).blur(); }) } });
            }
            if (this._selectedMeasure != "" && this._selectedFormat != "") {
                $("#" + this._id + "_numberFormatOption").ejDropDownList({ enableRTL: this.model.enableRTL, text: this._selectedFormat, create: function () { $(this.wrapper.find('.e-input')).focus(function () { $(this).blur(); }) } });
                $("#" + this._id + "_measureOption").ejDropDownList({ enableRTL: this.model.enableRTL, text: this._selectedMeasure, showCheckbox: true, create: function () { $(this.wrapper.find('.e-input')).focus(function () { $(this).blur(); }) } });
            }
            $("#" + this._id + "_categoricalInput").ejMaskEdit({ name: "mask", inputMode: ej.InputMode.Text, watermarkText: "Column Page Size" });
            $("#" + this._id + "_seriesInput").ejMaskEdit({ name: "mask", inputMode: ej.InputMode.Text, watermarkText: "Row Page Size" });

            $("#" + this._id + "_rowSumCheckBox,#" + this._id + "_colSumCheckBox,#" + this._id + "_bothSumCheckBox").ejCheckBox({ size: "small", showRoundedCorner: true });
            this.rowCheckBox = $("#" + this._id + "_rowSumCheckBox").data("ejCheckBox"); this.colCheckBox = $("#" + this._id + "_colSumCheckBox").data("ejCheckBox"); this.bothCheckBox = $("#" + this._id + "_bothSumCheckBox").data("ejCheckBox");
            if ($(evt.target).hasClass("e-summaryCustomize") || $(evt.element).hasClass("e-summaryCustomize")) {
                ...
                $("#" + this._id + "_hideSubTotal").ejDropDownList({
                    showCheckbox: true,
                    enableRTL: this.model.enableRTL,
                    create: function(){ $(this.wrapper.find('.e-input')).focus(function () { $(this).blur();})}
                });
                this.dropmeasure = $("#" + this._id + "_hideSubTotal").data("ejDropDownList");
                if (this.selval != undefined) {
                    this.dropmeasure.setModel({ value: this.selval });
                }
            }
            if ($(evt.target).hasClass("e-summaryTypes") || $(evt.element).hasClass("e-summaryTypes")) {
                $("#" + this._id + "_summaryOK,#" + this._id + "_summaryCancel").ejButton({ enableRTL: this.model.enableRTL });
                $("#" + this._id + "_drillMeasure").ejDropDownList({
                    selectedIndices: [0],
                    enableRTL: this.model.enableRTL,
                   create: function () { $(this.wrapper.find('.e-input')).focus(function () { $(this).blur(); }) }

                });
                $("#" + this._id + "_drillSum").ejDropDownList({
                ...
                drilmes = $("#" + this._id + "_drillMeasure").data("ejDropDownList");
                drilsum = $("#" + this._id + "_drillSum").data("ejDropDownList");
        ...
        _dialogOKBtnClick: function (e) {
            if (this._dialogName == "e-numberFormatting") {
                this._selectedFormat = $("#" + this._id + "_numberFormatOption").ejDropDownList("getSelectedValue");
                this._selectedMeasure = $("#" + this._id + "_measureOption").ejDropDownList("getSelectedValue");
            ...
            if (this._dialogName == "e-summaryCustomize") {
                ...
                if ($("#" + this._id + "_hideSubTotal").ejDropDownList("getSelectedValue") != null && this.model.analysisMode == "pivot" && this.model.operationalMode == ej.PivotGrid.OperationalMode.ClientMode) {
                    pGridObj.selval = $("#" + this._id + "_hideSubTotal").ejDropDownList("getSelectedValue");
                    var selectedValues = $("#" + this._id + "_hideSubTotal").ejDropDownList("getSelectedValue").split(',');
            ...
            if (this._dialogName == "e-summaryTypes") {
                if ($("#" + this._id + "_drillSum").val() != undefined) {
                    this.drilsumval = $("#" + this._id + "_drillMeasure").ejDropDownList("getSelectedValue");
                    var summarytyp = this.sumtyp = $("#" + this._id + "_drillSum").val();
                    if (summarytyp != null)
                        var s = summarytyp.toLowerCase();
                    if (this.model.operationalMode == ej.PivotGrid.OperationalMode.ClientMode) {
                        var len = $("#" + this._id + "_drillMeasure").ejDropDownList("getSelectedValue").split(",").length;
                        for (var i = 0; i < len; i++) {
                            var selectedValue = $("#" + this._id + "_drillMeasure").ejDropDownList("getSelectedValue").split(",")[i];
        ...
        _keyDownPress: function (e) {
            ...
            if (((e.which === 9 && e.shiftKey) || e.which === 9) && $("#" + this._id).find("#" + this._id + "_clientDlg_wrapper :visible").length > 0) {
                ...
                if ($(".e-pivotpager[data-targetcontrolid='" + this._id + "']:visible").length > 0 && $("#" + this._id + "_Pager_CategCurrentPage:visible").length > 0) {
                    focEle.push($("#" + this._id + "_Pager_CategCurrentPage:visible"));
                }
                if ($(".e-pivotpager[data-targetcontrolid='" + this._id + "']:visible").length > 0 && $("#" + this._id + "_Pager_SeriesCurrentPage:visible").length > 0) {
                    focEle.push($("#" + this._id + "_Pager_SeriesCurrentPage:visible"));
                }
                if (!ej.isNullOrUndefined(this._curFocus.tab)) {
        ...
        _endColResizing: function (e) {
           ...
           if (this.model.enableGroupingBar) {
               ...
               if(!this.model.frozenHeaderSettings.enableFrozenColumnHeaders && this.model.frozenHeaderSettings.enableFrozenRowHeaders)
                ...
                if (this.model.frozenHeaderSettings.enableFrozenColumnHeaders && !this.model.frozenHeaderSettings.enableFrozenRowHeaders)
                {
                    if (this.element.find("#" + this._id + "_coltable").width() < this.element.find(".valScrollArea").width())
                        this.element.find("#" + this._id + "_coltable").width(this.element.find(".valScrollArea").width());
                }
            this._target = null;
            this.element.find(".e-reSizeColbg").remove();
            this._expand = false;
                            ...
                            for (var key in this._tempFilterData[j]) {
                                if (this.model.analysisMode == ej.PivotGrid.AnalysisMode.Olap) {
                                    ...
                                    if (key == text && this._tempFilterData[j][text].length > 0)
                                        this.element.find("#" + this._id + "_pivotButton" + text).next().addClass("filtered");
                                }
                            }
                        }
                    }
        ...
        _createDialog: function (title, treeViewData) {
            ...
            memberSearchEditor = ej.buildTag("div.e-memberSearchEditorDiv", ej.buildTag("input#" + this._id + "_searchEditorTreeView.searchEditorTreeView").attr("type", "text")[0].outerHTML + (this.model.enableMemberEditorPaging && $.parseJSON(treeViewData).length >= this.model.memberEditorPageSize ? ej.buildTag("span.e-icon e-searchEditorTree", {})[0].outerHTML : ""), { "padding": isAdvancedFilter ? "5px 5px 0px 9px" : "0px" })[0].outerHTML;
            var dialogContent = ej.buildTag("div#" + this._id + "_EditorDiv.e-editorDiv", groupDropDown + ej.buildTag("div", filterElementTag + memberSearchEditor + ej.buildTag("div.e-memberEditorDiv", ej.buildTag("div#" + this._id + "_editorTreeView.e-editorTreeView", { "margin-top": this.model.enableAdvancedFilter ? "10px" : "2px" })[0].outerHTML)[0].outerHTML)[0].outerHTML)[0].outerHTML + ((!ej.isNullOrUndefined(treeViewData) && this.model.enableMemberEditorPaging && ($.parseJSON(treeViewData).length >= this.model.memberEditorPageSize || this.model.memberEditorPageSize < this._memberPageSettings.endPage)) ? "" : "</br>"),
            dialogFooter = ej.buildTag("div", ej.buildTag("button#" + this._id + "_OKBtn.e-dialogOKBtn", this._getLocalizedLabels("OK")).attr({ "title": this._getLocalizedLabels("OK"), tabindex: 0 })[0].outerHTML + ej.buildTag("button#" + this._id + "_CancelBtn.e-dialogCancelBtn", this._getLocalizedLabels("Cancel")).attr({ "title": this._getLocalizedLabels("Cancel"), tabindex: 0 })[0].outerHTML, { "float": "right", "margin": (isAdvancedFilter ? "-9px 5px 11px " : "-13px 0px 7px ") + "  0px" })[0].outerHTML,
            ...
            this.element.find("#" + this._id + "_clientDialog_wrapper").css("top", this.element[0].offsetTop + 20);
            ...
            if (isAdvancedFilter) {
                ...
                if (this.model.operationalMode == ej.PivotGrid.OperationalMode.ServerMode && this.model.analysisMode == ej.PivotGrid.AnalysisMode.Olap)
                    this.element.find("#" + this._id + "_clientDialog_wrapper").addClass("advancedFilterDlgOSM");
                var cntrlWidth = $(".cols-sample-area").position();
                if (cntrlWidth && cntrlWidth.left > 0) {
                    this.element.find("#" + this._id + "_clientDialog_wrapper").css({ "left": (pos.left + 50 - cntrlWidth.left), top: pos.top });
                }
                else if (!ej.isNullOrUndefined(pos))
                    this.element.find("#" + this._id + "_clientDialog_wrapper").css({ "left": pos.left+50, top: pos.top });
        ...
        _groupLabelChange: function (args) {
            ...
            if (this.model.operationalMode == ej.Pivot.OperationalMode.ClientMode) {
               ...
               this.element.find("#" + this._id + "_clearAllFilters a").text(this._getLocalizedLabels("ClearFilter") + " from \"" + args.text + "\"").append(filterElem);
                if (filterData.length > 0) {
                    if (filterData[0]["advancedFilterType"] == ej.Pivot.AdvancedFilterType.LabelFilter) {
                        this.element.find("#" + this._id + "_labelFilterBtn a:eq(0)").append(filterIndicator);
                        this.element.find("#" + this._id + "_labelFilterBtn .clearFilter").css("opacity", "1").removeAttr("disabled");
                        ...
                        this.element.find("#" + this._id + "_labelFilterBtn li#" + filterData[0]["labelFilterOperator"] + labelFilter + " a").append(activeFilter);
                        filterMenuObj.enableItemByID("labelClearFilter");
                    }
                    else {
                        this.element.find("#" + this._id + "_valueFilterBtn a:eq(0)").append(filterIndicator);
                        this.element.find("#" + this._id + "_valueFilterBtn .clearFilter").css("opacity", "1").removeAttr("disabled");
                        ...
                        this.element.find("#" + this._id + "_valueFilterBtn li#" + filterData[0]["valueFilterOperator"] + valueFilter+" a").append(activeFilter);
        ...
        _filterElementClick: function (args, me) {
            ...
            if (!ej.isNullOrUndefined(args.element)) 
                this._filterAction = $(args.element).parents("#" + this._id + "_valueFilterBtn").length==0 ? "labelFiltering" : "valueFiltering";
        ...
        _filterOptionChanged: function (args) {
            ...
            if (args.value.toLowerCase().indexOf("between") >= 0)
                $(valuesTd).html("<input type='text' id='" + this._id + "_filterValue1' class='e-filterValues' value='" + filterValue[0] + "' style='display:inline'/> <span>" + this._getLocalizedLabels("and") + "</span> <input type='text' id='" + this._id + "_filterValue2' value='" + (ej.isNullOrUndefined(filterValue[1]) ? "" : filterValue[1]) + "' class='e-filterValues' style='display:inline' /> </br>");
            if (args.value.toLowerCase().indexOf("between") < 0)
                $(valuesTd).html("<input type='text' id='" + this._id + "_filterValue1' class='e-filterValues' value='" + filterValue[0] + "' style='display:inline'/>");
        },

        _filterElementOkBtnClick: function (args) {
            ej.Pivot.closePreventPanel(this);
            var selectedOperator = this.element.find(".filterOptions")[0].value,
                enteredValue = [this.element.find("#" + this._id + "_filterValue1")[0].value],
            ...
            if ( this.model.operationalMode == ej.Pivot.OperationalMode.ServerMode) {
             ...
             selectedMeasure, params, levelFilterInfo = [], actionName = this._filterAction.toLowerCase();
                ...
                if (this.model.analysisMode == ej.Pivot.AnalysisMode.Olap) {
                    ...
                    var filterParams = this._curFilteredText + "::" + selectedOperator + "::" + selectedMeasure + "::" + enteredValue[0] + "::" + (this.element.find("#" + this._id + "_filterValue2").length > 0 ? this.element.find("#" + this._id + "_filterValue2")[0].value : "");
                    var serializedCustomObject = JSON.stringify(this.model.customObject), eventArgs = JSON.stringify({ "action": actionName, "filterParams": filterParams, "sortedHeaders": this._ascdes, "currentReport": report, "valueSorting": JSON.stringify(this.model.valueSortSettings), "customObject": serializedCustomObject, "gridLayout": this.model.layout });
                    this.doAjaxPost("POST", this.model.url + "/" + this.model.serviceMethodSettings.filtering, eventArgs, this._filterElementSuccess);
            ...
            if (this._filterAction == "valueFiltering") {
                ...
                this.element.find("#" + this._id + "_filterValue2")[0] != undefined ? "," + enteredValue.push(this.element.find("#" + this._id + "_filterValue2")[0].value) : enteredValue;
            }
            this.element.find(".e-dialog").remove();
        ...
        _nodeCheckChanges: function (args) {
            if (this._onDemandNodeExpand) {
                ...
                var isUnChecked = ((!ej.isNullOrUndefined(args.model.id) && args.model.id.toLowerCase() == this._id.toLowerCase() + "_allelement" && !args.isChecked) || ((!ej.isNullOrUndefined(args.id) && (args.id.toLowerCase() == "(all)_0" || args.id.toLowerCase() == "all")) && (!ej.isNullOrUndefined(args.type) && (args.type == "nodeUncheck"))));
                var isChecked = ((!ej.isNullOrUndefined(args.model.id) && args.model.id.toLowerCase() == this._id.toLowerCase() + "_allelement" && args.isChecked) || ((!ej.isNullOrUndefined(args.id) && (args.id.toLowerCase() == "(all)_0" || args.id.toLowerCase() == "all")) && (!ej.isNullOrUndefined(args.type) && (args.type == "nodeCheck"))));
                if (isUnChecked) {
                ...
                else if (((!ej.isNullOrUndefined(args.model.id) && args.model.id.toLowerCase() == this._id.toLowerCase() + "_allelement") || (!ej.isNullOrUndefined(args.id) && (args.id.toLowerCase() == "(all)_0" || args.id.toLowerCase() != "all"))) && (this.model.enableMemberEditorPaging || this._editorTreeData)) {
                ...
                else if ((!ej.isNullOrUndefined(args.model.id) && args.model.id.toLowerCase() == this._id.toLowerCase() + "_allelement") || (!ej.isNullOrUndefined(args.id) && (args.id.toLowerCase() == "(all)_0" || args.id.toLowerCase() != "all"))) {
        ...
        _fetchMemberSuccess: function (msg) {
            ...
            if (this.model.dataSource.enableAdvancedFilter) {
                this.element.find(".e-dialog #" + this._id + "_GroupLabelDrop_wrapper:visible").first().attr("tabindex", "-1").focus().addClass("e-hoverCell");
            }
        ...
        _applyToolTip: function (e) {
            if (this.model.enableToolTip) {
                ...
                if ($(targetCell).find("input").length == 0 && !$(targetCell).hasClass("curInput") && !ej.isNullOrUndefined($(targetCell).attr("role"))) {
                    ...
                    this.element.find("span#" + this._id + "_celval").remove();
                    ...
                    var tooltipval = $(targetCell).find("span.cellValue:not('#" + this._id + "_celval')").text();
                    if (this.model.enableRTL) {
                        $("#" + this._id + "_gridTooltip").append("<p id=\"" + this._id + "_value\" class=\"e-tooltipText\">" + (tooltipval ? tooltipval : this._getLocalizedLabels("NoValue")) + ":" + this._getLocalizedLabels("ToolTipValue") + "</p>");
                        $("#" + this._id + "_gridTooltip").append("<p id=\"" + this._id + "_row\" class=\"e-tooltipText\">" + ((rowValue == undefined || this._rowCount == 1) ? this._getLocalizedLabels("NoValue") : this._direction(rowValue)) + ":" + this._getLocalizedLabels("ToolTipRow") + "</p>");
                        $("#" + this._id + "_gridTooltip").append("<p id=\"" + this._id + "_column\" class=\"e-tooltipText\">" + ((columnValue == undefined || columnValue == "") ? this._getLocalizedLabels("NoValue") : this._direction(columnValue)) + ":" + this._getLocalizedLabels("ToolTipColumn") + "</p>");
                    }
                    else {
                        $("#" + this._id + "_gridTooltip").append("<p id=\"" + this._id + "_value\" class=\"e-tooltipText\">" + this._getLocalizedLabels("ToolTipValue") + ": " + (tooltipval ? tooltipval : this._getLocalizedLabels("NoValue")) + "</p>");
                        $("#" + this._id + "_gridTooltip").append("<p id=\"" + this._id + "_row\" class=\"e-tooltipText\">" + this._getLocalizedLabels("ToolTipRow") + ": " + ((rowValue == undefined || this._rowCount == 1) ? this._getLocalizedLabels("NoValue") : rowValue) + "</p>");
                        $("#" + this._id + "_gridTooltip").append("<p id=\"" + this._id + "_column\" class=\"e-tooltipText\">" + this._getLocalizedLabels("ToolTipColumn") + ": " + ((columnValue == undefined || columnValue == "") ? this._getLocalizedLabels("NoValue") : columnValue) + "</p>");
                    }
        ...
        _createCalculatedField: function () {
            ...
            var dialogContent = ej.buildTag("div#" + this._id + "_calculatedField.e-dlgCalculatedField", "<table class=\"outerTable\"><tr><td>" + nameLabel + "</td><td>" + calculateFieldList + "</td><td>" + addBtn + "</td></tr>" + "<tr><td>" + formulaLabel + "</td><td>" + formulaTextBox + calculatorFields + editFormula + "</td><td>" + deleteBtn + "</td></tr></table>" +"<p class=\"borderLine\"></p>"+ "<table class=\"e-fieldTable\"><tr><td>" + fieldsLabel + "</td></tr><tr><td>" + fieldCollection + "</td></tr><tr><td>" + insertButton + "</td></tr></table>")[0].outerHTML;
            var ejDialog = ej.buildTag("div#" + this._id + "_clientDialog.e-clientDialog", dialogContent + dialogFooter + calculatorDiv, { "opacity": "1" }).attr("title", dialogTitle)[0].outerHTML;
            $(ejDialog).appendTo("#" + this._id);
                ...
                if (this.model.operationalMode == ej.PivotGrid.OperationalMode.ClientMode) {
                    ...
                    for (var i = 0; i < axisItems.length; i++) {
                        ...
                        if (this.model.operationalMode == ej.PivotGrid.OperationalMode.ServerMode) {
                            ...
                            rowBtns += ej.buildTag("span.e-pivotButton", ej.buildTag("span.e-dropIndicator")[0].outerHTML + ej.buildTag("button.e-pvtBtn#" + this._id + "_pivotButton" + axisItems[i].FieldHeader || axisItems[i].FieldName || axisItems[i].Name || axisItems[i].DimensionHeader || axisItems[i].DimensionName, ((this.model.showUniqueNameOnPivotButton ? (axis != "values" ? axisItems[i].Tag : axisItems[i].FieldHeader || axisItems[i].FieldName || axisItems[i].Name || axisItems[i].DimensionHeader || axisItems[i].DimensionName) : axisItems[i].FieldHeader || axisItems[i].FieldName || axisItems[i].Name || axisItems[i].DimensionHeader || axisItems[i].DimensionName) + (axis == "filter" ? " (" + filterState + ")" : "")), {}, this.model.analysisMode == ej.Pivot.AnalysisMode.Pivot ? { "data-fieldName": axisItems[i].FieldName || axisItems[i].DimensionName || axisItems[i].FieldHeader || axisItems[i].DimensionHeader, "data-fieldCaption": axisItems[i].FieldHeader || axisItems[i].DimensionHeader || axisItems[i].FieldName || axisItems[i].DimensionName } : { "data-fieldCaption": axisItems[i].FieldHeader })[0].outerHTML +
                            ...
                            rowBtns += ej.buildTag("span.e-pivotButton", ej.buildTag("span.e-dropIndicator")[0].outerHTML + ej.buildTag("button.e-pvtBtn#" + this._id + "_pivotButton" + axisItems[i], axisItems[i])[0].outerHTML + ej.buildTag("span.filter e-icon " + filtered).attr("role", "button").attr("aria-label", "filter")[0].outerHTML + ej.buildTag("span.e-sorting e-icon " + sort).attr("role", "button").attr("aria-label", "sort").attr("aria-expanded", "false")[0].outerHTML + ej.buildTag("span.e-removeBtn e-icon").attr("role", "button").attr("aria-label", "remove")[0].outerHTML).attr("data-tag", tagAxis + ":" + axisItems[i])[0].outerHTML;
                    }
                }
                return rowBtns;
            }
        ...
        _createFields: function (tableOlapGrid, tableWidth, cellWidth) {
            ...
            if (this.model.enableVirtualScrolling && this.element.find(".virtualScrollGrid").length > 0)
                this.element.find(".virtualScrollGrid").prepend(ej.buildTag("div#" + this._id + "_groupingBarPivot.groupingBarPivot")[0].outerHTML);
            else
                this.element.prepend(ej.buildTag("div#" + this._id + "_groupingBarPivot.groupingBarPivot")[0].outerHTML);
            ...
            if (this.element.find(".columns").height() > 51) {
				...
				var columnButton = this.element.find(".columns .e-pivotButton");
				var cBtn = this.element.find(".columns .e-pvtBtn");
				for (var i = 0; i < columnButton.length; i++) {
					if (columnButton[i].offsetWidth > this.element.find(".columns").width()) {
						var btnWidth = this.element.find(".columns").width() - ((this.element.find(".columns .e-pivotButton").width() - this.element.find(".columns .e-pivotButton .e-pvtBtn").width()) + 40);
						cBtn[i].style.width = btnWidth + "px";
						cBtn[i].style.textOverflow = "ellipsis"				
					}
					if (parseInt(cBtn[i].style.width) < 40)
						cBtn[i].style.width = "40px";
				}
            }
            ...
            if (this.element.find(".values").height() > 51) {
                if (!this.model.isResponsive)
				...
				var valueButton = this.element.find(".values .e-pivotButton");
				var vBtn = this.element.find(".values .e-pvtBtn");
				for (var i = 0; i < valueButton.length; i++) {
					if (valueButton[i].offsetWidth > this.element.find(".values").width()) {
						var btnWidth = this.element.find(".values").width() - ((this.element.find(".values .e-pivotButton").width() - this.element.find(".values .e-pivotButton .e-pvtBtn").width()) + 40);
						vBtn[i].style.width = btnWidth + "px";
						vBtn[i].style.textOverflow = "ellipsis"				
					}
					if (parseInt(vBtn[i].style.width) < 40)
						vBtn[i].style.width = "40px";
				}
            }
            var addedbtnwidth = 0;
                ...
                if (this.model.operationalMode == ej.PivotGrid.OperationalMode.ServerMode) {
                    ...
                    if (this._schemaData != null) {
                        ...
                        if (this.model.analysisMode == ej.Pivot.AnalysisMode.Olap)
                            ...
                            this._schemaData.element.find("#" + this._id + "_pivotButton" + headerText).parent().remove();
        ...
        renderControlFromJSON: function () {
            ...
            if ($(this.element).parents(".e-pivotclient").length > 0 && this._pivotClientObj.model.enableToolBar && !this._pivotClientObj.model.displaySettings.enableFullScreen)
                var toolBar = $("<div id=" + this._id + "_Toolbar style='width:" + this._pivotClientObj._gridWidth + ";height:" + this._pivotClientObj._gridHeight + ";overflow:auto;margin-top:5px;margin-left:5px'></div>");
            ...
            if ($(this.element).parents(".e-pivotclient").length > 0 && this._pivotClientObj.model.enableToolBar && !this._pivotClientObj.model.displaySettings.enableFullScreen) {
                $("#" + this._id).prepend("<div class='toolBar' style='height:40px,width:" + this.element.find("#" + this._id + "_PivotGridToolbar").width() + "px'></div>");
                var numberformatting = "", collapseByDefault = "", frozenHeader = ej.buildTag("li#" + this._id + "_frozenHeaders.e-frozenHeaders e-icon", "", {}).attr("aria-label", this._getLocalizedLabels("FrozenHeader")).attr({ "title": this._getLocalizedLabels("FrozenHeader"), tabindex: 0 })[0].outerHTML;
                ...
                if (this.model.analysisMode == ej.Pivot.AnalysisMode.Pivot)
                    collapseByDefault = ej.buildTag("li#" + this._id + "_collapseByDefault.e-collapseByDefault e-icon", "", {}).attr("aria-label", this._getLocalizedLabels("CollapseByDefault")).attr({ "title": this._getLocalizedLabels("CollapseByDefault"), tabindex: 0 })[0].outerHTML;
                ...
                (this.model.analysisMode == ej.Pivot.AnalysisMode.Pivot ? ej.buildTag("li#" + this._id + "_cellEditing.e-cellEditing e-icon", "", {}).attr("aria-label", this._getLocalizedLabels("CellEditing")).attr({ "title": this._getLocalizedLabels("CellEditing"), tabindex: 0 })[0].outerHTML : " ") +
                ej.buildTag("li#" + this._id + "_drillThrough.e-drillThrough e-icon", "", {}).attr("aria-label", this._getLocalizedLabels("DrillThrough")).attr({ "title": this._getLocalizedLabels("DrillThrough"), tabindex: 0 })[0].outerHTML+
                ...
                ej.buildTag("li#" + this._id + "_columnResize.e-columnResize e-icon", "", {}).attr("aria-label", this._getLocalizedLabels("ColumnResize")).attr({ "title": this._getLocalizedLabels("ColumnResize"), tabindex: 0 })[0].outerHTML +
                ...
                ej.buildTag("ul", ej.buildTag("li#" + this._id + "_summaryCustomize.e-summaryCustomize e-icon", "", {}).attr("aria-label", this._getLocalizedLabels("SummaryCustomization")).attr({ "title": this._getLocalizedLabels("SummaryCustomization"), tabindex: 0 })[0].outerHTML +
        ...
        _renderFrozenGridTable: function (tableOlapGrid, colHeader, tableBody) {
            ...
            if ($(tRow).length > 0) {
                ...
                $(colfrediv).append($("<table id='" + this._id + "_colfretable' style='height:100%'></table>").append(tRow));
            }

            var valScrollArea = $(ej.buildTag("div#" + this._id + "_rowvaluecontent.valScrollArea")[0].outerHTML);
            ...
            if (!this.model.frozenHeaderSettings.enableFrozenRowHeaders && this.model.frozenHeaderSettings.enableFrozenColumnHeaders) {
                ...
                $(tableOlapGrid).find("tr:first td:eq(0)").append($("<div id='" + this._id + "_headerContent' class='headerContent'></div>"))
                ...
                $(tableOlapGrid).find("tr:first td:eq(0)").append($("<div id='" + this._id + "_headerContent' class='headerContent' style='position:relative'></div>"));
        ...
        _refreshScroller: function () {
            ...
            if (this.element.find(".pivotGridValueTable .value:visible").length > 0) {
                ...
                if (!this.model.frozenHeaderSettings.enableFrozenRowHeaders && this.model.frozenHeaderSettings.enableFrozenColumnHeaders) {
                    ...
                    this.element.find("#" + this._id + "_rowvaluecontent").ejScroller({
                    ...
                    this.element.find(".headerContent").css({ "height": this.element.find("#" + this._id + "_rowvaluecontent").height(), "overflow": "hidden", "border-right": "0px" });
                    this.element.find(".rowhead").css("padding-bottom", (this.element.find("#" + this._id + "_rowvaluecontent .e-hscrollbar").length > 0) ? scrollerSize : "0px");
                    if (this.model.enableGroupingBar) {
                    ...
                    if(this.element.find("#" + this._id + "_rowvaluecontent .e-hscrollbar").length > 0){
