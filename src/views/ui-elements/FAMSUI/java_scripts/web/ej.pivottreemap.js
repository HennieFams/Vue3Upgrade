...
*/
(function (fn) {
    typeof define === 'function' && define.amd ? define(["./../common/ej.globalize","./../common/ej.core","./../common/ej.data","./../common/ej.touch","./ej.waitingpopup","./../datavisualization/ej.treemap","./ej.pivotanalysis.base","./ej.olap.base","./ej.pivot.common"], fn) : fn();
})
(function () {
            ...
            if (!ej.isNullOrUndefined(ptreemapProxy._treeMap)) {
                if (ptreemapProxy._treeMap.model.legendSettings.dockPosition == "top") {
                    if (!ptreemapProxy.element.find("#" + ptreemapProxy._id + "TreeMapContainer").children().hasClass("e-drillupAction"))
                        $(ej.buildTag("div#" + this._id + "_drillHeader .e-drillupAction", ptreemapProxy._showDrillText, { "height": "25px", "width": "99.8%", "z-index": "10", "position": "absolute", "margin-top": "33px" })[0].outerHTML).insertAfter($("#" + ptreemapProxy._id + "TreeMapContainer").find(".LegendDiv").css("margin-top", "-50px").css("font-size", "12px"));
                }
                else {
                    ...
                    $(ej.buildTag("div#" + this._id + "_drillHeader .e-drillupAction", ptreemapProxy._showDrillText, { "height": "25px", "width": "99.8%", "position": "absolute", "margin-top": "-32px" })[0].outerHTML).insertBefore($("#" + ptreemapProxy._id + "TreeMapContainer").find("#" + this._id + "_backgroundTile"));
                }
            }
        },
