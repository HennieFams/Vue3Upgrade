...
*/
(function (fn) {
    typeof define === 'function' && define.amd ? define(["./../common/ej.globalize","./../common/ej.core","./../common/ej.data","./../common/ej.touch","./../common/ej.draggable","./../common/ej.scroller","./ej.button","./ej.checkbox","./ej.dropdownlist","./ej.dialog","./ej.toolbar","./ej.maskedit","./ej.waitingpopup","./ej.treeview","./ej.tab","./ej.pivotchart","./ej.pivotgrid","./ej.pivotschemadesigner","./../datavisualization/ej.chart","./ej.pivotanalysis.base","./ej.olap.base","./ej.pivot.common"], fn) : fn();
})
(function () {
...
(function ($, ej, undefined) {
    ...
    ej.widget("ejPivotClient", "ej.PivotClient", {
        ...
        _load: function () {
			...
			if ($("#" + this._id).parent()[0]) {
				$("#" + this._id).parent()[0].style.position = "relative";
                 this.element.ejWaitingPopup({ showOnInit: true , appendTo: $("#" + this._id).parent()[0] });
		    }
        ...
        _createControl: function () {
            ...
            this.reportDropTarget = this.element.find('#' + this._id + '_reportList').data("ejDropDownList");
            ...
            this.element.find("#" + this._id + "_clientTab").ejTab({ enableRTL: this.model.enableRTL, itemActive: ej.proxy(this._onTabClick, this) });
            if (!this.model.enableSplitter)
        ...
        _createMeasureGroup: function () {
            ...
            var measureGroupDropdown = "<div class ='measureGroupselector' style='margin:5px 5px 0px 5px'><input type='text' id='" + this._id + "_measureGroupSelector' class='measureGroupSelector' /></div>";
        ...
        _wireEvents: function () {
            ...
            this.element.find("#" + this._id + "_sep1").hover(function () {
            ...
            if (!this.model.isResponsive) {
                if (!(this.model.analysisMode == ej.Pivot.AnalysisMode.Olap && this.model.operationalMode == ej.Pivot.OperationalMode.ServerMode && this.model.enableVirtualScrolling)) {
                    this.element.find(".e-parentsplit, .e-serverparentsplit").ejSplitter({
                        ...
                        isResponsive: true,
                        enableRTL: this.model.enableRTL,
                        height: this.model.analysisMode == ej.Pivot.AnalysisMode.Olap && this.model.operationalMode == ej.Pivot.OperationalMode.ServerMode ? this.element.height() - ((this.element.find("div.e-titleText").length > 0 ? 50 : 0) + this.element.find("#" + this._id + "_reportToolbar").height() + 5) : this.element.find(".e-outerTable").height(),
                ...
                this.element.find(".e-childsplit, .e-serverchildsplit").ejSplitter({
                    cssClass: "customCSS",
                    height: this.model.analysisMode == ej.Pivot.AnalysisMode.Olap && this.model.operationalMode == ej.Pivot.OperationalMode.ServerMode ? (this.element.height() - ((this.element.find("div.e-titleText").length > 0 ? 50 : 0) + this.element.find("#" + this._id + "_reportToolbar").height() + this.element.find(".e-csHeader").height() + (this.model.enableVirtualScrolling ? 25 : 15))) : "",
                    isResponsive: true,
                    enableRTL: this.model.enableRTL,
                ...
                this.element.find(".e-splitresponsive, .e-serversplitresponsive").ejSplitter({
                    cssClass: "customCSS",
                    isResponsive: true,
                    height: this.model.analysisMode == ej.Pivot.AnalysisMode.Olap && this.model.operationalMode == ej.Pivot.OperationalMode.ServerMode ? (this.element.height() - ((this.element.find("div.e-titleText").length > 0 ? 50 : 0) + this.element.find("#" + this._id + "_reportToolbar").height() + this.element.find(".e-csHeader").height() + 25)) : "",
        ...
        _keyPressDown: function (e) {
            ...
            if (((e.which === 9 && e.shiftKey) || e.which === 9) && this.element.find(".e-dialog:visible").length > 0) {
                ...
                var focEle;
                if ((!ej.isNullOrUndefined(this._dllSortMeasure) && this._dllSortMeasure.model.enabled && this.element.find("#" + this._id + "_measuresList_container:visible").length > 0) || (!ej.isNullOrUndefined(this._dllfMeasuresList) && this._dllfMeasuresList.model.enabled && this.element.find("#" + this._id + "_fMeasuresList_container:visible").length > 0)) {
                    focEle = this.element.find(".e-dialog .e-filterEnable:visible,#" + this._id + "_measuresList_container:visible,#" + this._id + "_fMeasuresList_container:visible,#" + this._id + "_filterCondition_container:visible,.e-dialog .filterFrom:visible:not([disabled='disabled']),.e-dialog .filterTo:visible:not([disabled='disabled']),.e-dialog .e-radioBtnAsc:visible:not([disabled='disabled']),.e-dialog .e-preserveHrchy:visible:not([disabled='disabled']),.e-dialog .e-dialogOKBtn:visible:not([aria-disabled='true']),.e-dialog .e-dialogCancelBtn:visible,.e-dialog .e-close:visible,.e-dialog .e-checkAll:visible,.e-dialog .e-unCheckAll:visible,.e-dialog .e-sortfiltTab .e-active:visible,.e-dialog .e-measureEditor:visible:first,.e-dialog .e-text:visible:first,.e-dialog .e-sortEnable:visible,.e-dialog .reportName:visible,#" + this._id + "_reportNameList_container:visible");
                }
                else {
                ...
                if ($(".e-fullScreenView").length != 0) {
                    ...
                    focEle = this.element.find("[role='columnheader']:visible:not([p='0,0']):first,.e-schemaFieldTree .e-text:visible:first,.e-reportToolbar li:visible:first,#" + this._id + "_reportList_wrapper:visible,#" + this._id + "_cubeList_wrapper:visible,#" + this._id + "_cubeSelector_wrapper:visible, .e-cubeTreeView .e-text:visible:first,.e-categoricalAxis button:visible:first,.e-rowAxis button:visible:first,.e-slicerAxis button:visible:first,.e-schemaColumn button:visible:first,.schemaRow button:visible:first,.schemaFilter button:visible:first,.e-schemaValue button:visible:first,.e-toggleExpandButton:visible:first,.e-toggleCollapseButton:visible:first,#" + this._id + "_clientTab .e-active:visible");
                }
        ...
        _wireDialogEvent: function () {
            ...
            this.element.find(".e-reportDBImg").click(function (evt) {
                var pivotClientObj = $(this).parents(".e-pivotclient").data("ejPivotClient");
                var reportDBDlg = ej.buildTag("div.e-reportDBDialog#" + this._id + "_reportDBDialog", ej.buildTag("table", ej.buildTag("tbody", ej.buildTag("tr",
            ...
            this.element.find(".e-chartTypesImg").click(function (evt) {
                var pivotClientObj = $(this).parents(".e-pivotclient").data("ejPivotClient");
                var chartTypesDlg = ej.buildTag("div.e-chartTypesDialog#" + this._id + "_chartTypesDialog", ej.buildTag("table", ej.buildTag("tbody", ej.buildTag("tr",
                ...
                if (loadDlgTitle == pivotClientObj._getLocalizedLabels("Load")) {
                    ...
                    if (pivotClientObj._args_innerHTML != "ToolbarButtons") {
                        ...
                        if ((pivotClientObj.model.operationalMode == ej.Pivot.OperationalMode.ServerMode && pivotClientObj.model.analysisMode == ej.Pivot.AnalysisMode.Olap)) {
                            var reportDropTarget = pivotClientObj.element.find('#' + pivotClientObj._id + '_reportList').data("ejDropDownList");
                        ...
                        if (pivotClientObj.element.find(".e-dialog:not(.e-calcMemberDialog, .e-calcMemberDialog .e-dialog) .e-titlebar").first().text() == pivotClientObj._getLocalizedLabels("RemoveReport") && pivotClientObj.reportsCount < 2)
                            ...
                            this.reportDropTarget = pivotClientObj.element.find('#' + pivotClientObj._id + '_reportList').data("ejDropDownList");
        ...
        _updateReportCollection: function (isSaveRpt) {
            ...
            reportList = this.element.find('#' + this._id + '_reportList').data("ejDropDownList");
            if (!ej.isNullOrUndefined(this._pivotSchemaDesigner) && this._pivotSchemaDesigner.element.find(".cubeList").length > 0) {
                ...
                cubeList = this.element.find('#' + this._id + '_cubeSelector').data("ejDropDownList");
            }
            if (this.model.analysisMode == ej.Pivot.AnalysisMode.Olap && this.model.operationalMode == ej.Pivot.OperationalMode.ServerMode)
        ...
        _calculateHeight: function () {
            ...
            if (this.model.analysisMode == ej.Pivot.AnalysisMode.Olap && this.model.operationalMode == ej.Pivot.OperationalMode.ServerMode) {
                var ctrlPanelHeight = this.element.height() - ((this.element.find("div.e-titleText").length > 0 ? 50 : 0) + this.element.find("#" + this._id + "_reportToolbar").height() + 5);
                ...
                this.element.find(".e-cubeTable").css("height", ((this.element.height() - ((this.element.find("div.e-titleText").length > 0 ? 50 : 0) + this.element.find("#" + this._id + "_reportToolbar").height() + this.element.find(".e-csHeader").height() + 38)) + "px"));
                cdbHeight = this.element.height() - ((this.element.find("div.e-titleText").length > 0 ? 50 : 0) + this.element.find("#" + this._id + "_reportToolbar").height() + this.element.find(".e-csHeader").height() + 38);
                ...
                if (this.model.enableSplitter)
                    this.element.find(".e-serversplitresponsive").height(this.element.height() - ((this.element.find("div.e-titleText").length > 0 ? 50 : 0) + this.element.find("#" + this._id + "_reportToolbar").height() + this.element.find(".e-csHeader").height() + 30));
            }
            else {
                var ctrlPanelHeight = this.element.height() - ((this.element.find("div.e-titleText").length > 0 ? 50 : 0) + this.element.find("#" + this._id + "_reportToolbar").height() + 5);
                ...
                if (this.enableTogglePanel() && this.element.find(".pivotFieldList").length > 0) {
                    ...
                    this.element.find(".e-togglePanel").height((this.element.height() - ((this.element.find("div.e-titleText").length > 0 ? 50 : 0) + this.element.find("#" + this._id + "_reportToolbar").height() + 5)) + "px").width(14);
                    this.element.find(".e-toggleExpandButton,.e-toggleCollapseButton").css("margin-top", (this.element.find("#" + this._id + "_PivotSchemaDesigner").parents("td:eq(0)").height() - 9) / 2);
                    this.element.find(".e-togglePanel").children().addClass("e-toggleButtons");
                    if (this.model.enableRTL)
        ...
        _rwdToggleExpand: function () {
            ...
            if (this._parentElwidth < 850) {
                ...
                this.element.find("#" + this._id + "_cubeSelector_wrapper").css({ "width": "100%" });
            ...
            if (this._parentElwidth > 850) {
                ...
                if (window.navigator.userAgent.indexOf('Trident') > 0) {
                    ...
                    this.element.find("#" + this._id + "_cubeSelector_wrapper").width(($("#" + this._id).width() * 29 / 100 - 60) + "px");
                    if (!this.model.enableSplitter)
                    ...
                    this.element.find("#" + this._id + "_cubeSelector_wrapper").css({ "width": ($("#" + this._id).width() * 32 / 100 - 60) + "px" });
                    if(!this.model.enableSplitter)
                    this.element.find(".cubeTableTD, .e-cubeBrowser, .e-cdbHeader").css({ "width": (($(".e-cubeTable").width() / 2)-4) + "px" });
                    if (this.controlPlacement() == ej.PivotClient.ControlPlacement.Tile && this.displayMode() == "chartandgrid")
            ...
            if (uniqueName && uniqueName.indexOf("].") >= 0) {
                ...
                if (this._excelFilterInfo.length > 0) {
                    var cubeName = this.element.find('.cubeSelector').data("ejDropDownList").model.value,
                        reportName = this.element.find('#' + this._id + '_reportList').data("ejDropDownList").model.value,
                ...
                var reportName = this.element.find('#' + this._id + '_reportList').data("ejDropDownList").model.value;
                this._excelFilterInfo = $.grep(this._excelFilterInfo, function (item, index) {
        ...
        _groupLabelChange: function (args) {
            ...
            var sortInfo = [];
            if (this._excelFilterInfo.length > 0) {
                var cubeName = this.element.find('.cubeSelector').data("ejDropDownList").model.value, reportName = this.element.find('#' + this._id + '_reportList').data("ejDropDownList").model.value, levelName = this._selectedLevelUniqueName, hierarchyName = this._selectedFieldName;
            ...
            var filterElem = this.element.find("#" + this._id + "_clearAllFilters a").children().clone();
            this.element.find("#" + this._id + "_clearAllFilters a").text(this._getLocalizedLabels("ClearFilter") + " from \"" + this.element.find(".groupLabelDrop").data("ejDropDownList").model.text + "\"").append(filterElem);
            ...
            if ((filterInfo.length > 0 && (ej.isNullOrUndefined(filterInfo[0]["sortInfo"]) || (!ej.isNullOrUndefined(filterInfo[0]["sortInfo"]) && filterInfo[0]["sortInfo"].length == 0)) || filterInfo.length == 0))
                ...
                if (filterInfo[0]["sortInfo"].length > 0)
                    this.element.find("#" + this._id + filterInfo[0]["sortInfo"] + " span:eq(0)").addClass("e-selectedSort");
            }
            this.element.find(".e-clrFilter").parents("li:eq(0)").css("opacity", "0.5").attr("disable", true);
            this.element.find("#" + this._id + "_labelClearFilter").css("opacity", "0.5").attr("disable", true);
            this.element.find("#" + this._id + "_valueClearFilter").css("opacity", "0.5").attr("disable", true);
            ...
            if (filterInfo.length > 0 && !ej.isNullOrUndefined(filterInfo[0]["operator"])) {
                ...
                this.element.find("#" + filterTag + "#" + this._id + "_labelClearFilter").removeAttr("style disable");
                this.element.find("#" + filterTag + "#" + this._id + "_valueClearFilter").removeAttr("style disable");
        ...
        _filterElementClick: function (args) {
            ...
            var cubeName = this.element.find('.cubeSelector').length > 0 ? (this.element.find('.cubeSelector').data("ejDropDownList").model.value) : "", reportName = this.element.find('#' + this._id + '_reportList').data("ejDropDownList").model.value, levelName = this._selectedLevelUniqueName, hierarchyName = this._selectedFieldName;
            ...
            if (!($(args.element).attr("id") == "labelClearFilter" || ($(args.element).attr("id") == "valueClearFilter")) && !$(args.element).parent(".e-filterElementTag").length > 0) {
                var currentAction = $(args.element).parents("li:eq(0)#" + this._id + "_valueFilterBtn").length > 0 ? "valueFilterDlg" : "labelFilterDlg";
                var filterVal = [];
                ...
                if (!isSorted)
                    this._excelFilterInfo.push({ cubeName: this.element.find('.cubeSelector').length > 0 ? (this.element.find('.cubeSelector').data("ejDropDownList").model.value) : "", report: this.element.find('#' + this._id + '_reportList').data("ejDropDownList").model.value, hierarchyUniqueName: this._selectedFieldName, levelUniqueName: this._selectedLevelUniqueName, sortOrder: $(args.element).attr("id") });
                ...
                this._excelFilterInfo.push({ cubeName: this.element.find('.cubeSelector').length > 0 ? (this.element.find('.cubeSelector').data("ejDropDownList").model.value) : "", report: this.element.find('#' + this._id + '_reportList').data("ejDropDownList").model.value, hierarchyUniqueName: this._selectedFieldName, levelUniqueName: this._selectedLevelUniqueName, sortOrder: sortOrder });
        ...
        _filterOptionChanged: function (args) {
            var currentAction = this.element.find("#" + this._id + "_filterDialog_wrapper .e-titlebar").text().indexOf("Value") >= 0 ? "valueFilterDlg" : "labelFilterDlg";
        ...
        _filterElementOkBtnClick: function (args) {
            ...
            var selectedOperator = (this.element.find("#" + this._id + "_filterOptions").data("ejDropDownList").model.value || this.element.find("#" + this._id + "_filterOptions")[0].value),
                filterValue1 = this.element.find("#" + this._id + "_filterValue1")[0].value,
                filterValue2 = (this.element.find("#" + this._id + "_filterValue2").length > 0 ? this.element.find("#" + this._id + "_filterValue2")[0].value : ""),
            ...
            if (this.element.find(".filterMeasures").length > 0) {
                if (this.element.find("#" + this._id + "_filterValue2").length > 0)
            ...
            var sortOrder = this._removeFilterTag(this._selectedLevelUniqueName);
            this._excelFilterInfo.push({ cubeName: this.element.find('.cubeSelector').length > 0 ? (this.element.find('.cubeSelector').data("ejDropDownList").model.value) : "", report: this.element.find('#' + this._id + '_reportList').data("ejDropDownList").model.value, action: actionName, hierarchyUniqueName: this._selectedFieldName, levelUniqueName: this._selectedLevelUniqueName, operator: selectedOperator, measure: selectedMeasure, value1: filterValue1, value2: filterValue2, sortOrder: sortOrder });
        ...
        _maxViewBtnClick: function () {
            ...
            var maxViewCls = ej.buildTag("div#" + this._id + "_Winclose.e-winCloseBtn e-icon", "").attr("role", "button").attr("aria-label", "close").attr("clientID", this._id);
            if (this.displayMode() != ej.PivotClient.DisplayMode.GridOnly) {
                this.chartObj = null;
                this.chartObj = this.element.find("#" + this._pivotChart._id + "Container").data("ejChart");
                if (ej.isNullOrUndefined(this.chartObj) && this.model.enablePivotTreeMap && !ej.isNullOrUndefined(this.otreemapObj))
        ...
        _buttonContextMenu: function () {
            var context = ej.buildTag("ul.pivotTree#" + this._id + "_pivotTree", ej.buildTag("li", ej.buildTag("a", this._getLocalizedLabels("AddToColumn"))[0].outerHTML)[0].outerHTML + ej.buildTag("li", ej.buildTag("a", this._getLocalizedLabels("AddToRow"))[0].outerHTML)[0].outerHTML + ej.buildTag("li", ej.buildTag("a", this._getLocalizedLabels("AddToSlicer"))[0].outerHTML)[0].outerHTML)[0].outerHTML;
            this.element.append(context);
            $("#" + this._id + "_pivotTree").ejMenu({
        ...
        _renderLayout: function () {
            ...
            var reportToolBar = ej.buildTag("div.e-reportToolbar#" + this._id + "_reportToolbar", this._reportToolbar(), { width: "410px", height: "29px" })[0].outerHTML;
            ...
            if (this.model.enableSplitter && this.model.enableRTL) {
                ...
                this.element.find(".e-controlPanel").css("right", 3);
            var reportDropDown = "<div class ='reportList' ><input type='text' id='" + this._id + "_reportList' class='reportlist' title='" + this._getLocalizedLabels("ReportList") + "'/></div>";
        ...
        _calculateSize: function () {
            ...
            if (!(this.model.analysisMode == ej.Pivot.AnalysisMode.Olap && this.model.operationalMode == ej.Pivot.OperationalMode.ServerMode)) {
                ...
                if (this.model.enableVirtualScrolling)
                    ...
                    this.element.find(".e-controlPanel").height(ctrlPanelHeight);
                this.element.find(".e-cubeTable").height((this.element.height() - ((this.element.find("div.e-titleText").length > 0 ? 50 : 0) + this.element.find("#" + this._id + "_reportToolbar").height() + this.element.find(".e-csHeader").height() + 38)));
                if (this.model.isResponsive) {
        ...
        _renderControlSuccess: function (msg) {
            ...
            var reportBar = ej.buildTag("div.e-reportToolbar#" + this._id + "_reportToolbar", this._reportToolbar(), { width: "410px", height: "29px" })[0].outerHTML;
            var browserPanel, htmlTag;
            if (this.model.enableSplitter) {
                if (!this.model.isResponsive) {
                    if (this.model.enableRTL) {
        ...
        _contextOpen: function (args) {
            ...
            var menuObj = $("#" + this._id + "_pivotTree").data('ejMenu');
        ...
        _onContextOpen: function (args) {
            if ($(args.target).find(".e-folderCDB").length > 0 || $(args.target).find(".e-calcMemberGroupCDB").length > 0)
                return false;
            ej.Pivot.openPreventPanel(this);
            var menuObj = $("#" + this._id + "_pivotTreeContext").data('ejMenu');
            this._selectedMember = $(args.target);
            menuObj.enableItem(this._getLocalizedLabels("AddToColumn"));
            menuObj.enableItem(this._getLocalizedLabels("AddToRow"));
            if ($(args.target).find(".e-calcMemberCDB").length > 0)
                menuObj.showItems(["#" + this._id + "_Remove"]);
            else
                menuObj.hideItems(["#" + this._id + "_Remove"]);
        ...
        _toggleAxisSuccess: function (msg) {
            ...
            if (this.model.analysisMode == ej.Pivot.AnalysisMode.Pivot) {
                ...
                if (this.model.OperationalMode == ej.Pivot.AnalysisMode.ServerMode) {
                    ...
                    this.element.find(".e-cubeTable").height((this.element.height() - ((this.element.find("div.e-titleText").length > 0 ? this.element.find("div.e-titleText").height() : 0) + this.element.find("#" + this._id + "_reportToolbar").height() + this.element.find(".e-csHeader").height() + 38)));
                    this.element.find(".cdbTD, .cubeTableTD").height(this.element.find(".e-cubeTable").height());
        ...
        _measureGroupChangedSuccess: function (cubeTree) {
            ...
            var cubeTree = ej.buildTag("div#" + this._id + "_cubeTreeView.e-cubeTreeView")[0].outerHTML;
        ...
        _cubeChangedSuccess: function (report) {
            ...
            this.element.find(".e-cubeTable").height((this.element.height() - (this.element.find("div.e-titleText").height() + this.element.find("#" + this._id + "_reportToolbar").height() + this.element.find(".e-csHeader").height() + 38)));
            this.element.find(".cdbTD, .cubeTableTD").height((this.element.height() - (this.element.find("div.e-titleText").height() + this.element.find("#" + this._id + "_reportToolbar").height() + this.element.find(".e-csHeader").height() + 38)));
        ...
        _treeContextMenu: function () {
            var contextTag = ej.buildTag("ul.pivotTreeContext#" + this._id + "_pivotTreeContext", ej.buildTag("li", ej.buildTag("a", this._getLocalizedLabels("AddToColumn"))[0].outerHTML)[0].outerHTML + ej.buildTag("li", ej.buildTag("a", this._getLocalizedLabels("AddToRow"))[0].outerHTML)[0].outerHTML + ej.buildTag("li", ej.buildTag("a", this._getLocalizedLabels("AddToSlicer"))[0].outerHTML)[0].outerHTML + ej.buildTag("li#" + this._id + "_Remove", ej.buildTag("a", this._getLocalizedLabels("Remove"))[0].outerHTML)[0].outerHTML)[0].outerHTML;
            $(this.element).append(contextTag);
            $("#" + this._id + "_pivotTreeContext").ejMenu({
                menuType: ej.MenuType.ContextMenu,
                openOnClick: false,
                ...
                if ((report.d != undefined && report.d || report[0] != undefined && report[0]) || report.CurrentReport || report.PivotReport) {
                    ...
                    if (action != "Report Change") {
                        ...
                        if (action == "Load Report") {
                            ...
                            if (this._excelFilterInfo.length > 0) {
                                var cubeName = this.element.find('.cubeSelector').data("ejDropDownList").model.value, reportName = this.element.find('#' + this._id + '_reportList').data("ejDropDownList").model.value;
                                this._excelFilterInfo = $.grep(this._excelFilterInfo, function (item, index) {
        ...
        _createCubeSelector: function () {
            return ej.buildTag("div.e-csHeader", ej.buildTag("span.cubeText", this._getLocalizedLabels("CubeSelector"), { "padding-left": "6px", "float": "left", "margin-bottom": "10px", "width": this.model.enableSplitter && !this.model.isResponsive ? "25%" : "", "text-overflow": "ellipsis" })[0].outerHTML + ej.buildTag("div.cubeSelect", "<input type='text' id='" + this._id + "_cubeSelector' class ='cubeSelector' />", { display: "inline", "float": "left", "padding-left": this.model.enableSplitter ? "1%" : "8px", "position": "relative", "top": "-3px", "width": this.model.enableSplitter && !this.model.isResponsive ? "70.5%" : "" })[0].outerHTML, { width: (this.model.isResponsive || this.model.enableSplitter) ? "100%" : "", height: "20px" })[0].outerHTML;
        },
        ...
        _controlPanel: function () {
            ...
            if (this.displayMode() != ej.PivotClient.DisplayMode.GridOnly) {
                ...
                if (this.controlPlacement() == ej.PivotClient.ControlPlacement.Tile && this.displayMode() == ej.PivotClient.DisplayMode.ChartAndGrid) {
                    if (this.defaultView() == ej.PivotClient.DefaultView.Grid)
                        chartDiv = ej.buildTag("div#" + this._id + "_chartPanel.e-chartPanel", ej.buildTag("div.e-chartContainer", ej.buildTag("div#" + this._id + "_PivotChart", "", { "overflow": this.model.enableToolBar || this.model.isResponsive ? "" : "auto", "border": this.model.enableToolBar ? "none" : "" })[0].outerHTML, { "position": "relative", "overflow": this.model.enableToolBar || this.model.enableSplitter ? "" : "auto", "left": "-2px", "padding": this.model.enableToolBar ? "5px 0px 5px 0px" : this.model.enableSplitter ? "5px 3px 5px 5px" : "5px 0px 5px 5px", "width": (this.model.isResponsive) ? "99.2%" : (this.model.enableSplitter ? "inherit" : ""), "border-top": "none", "margin-right": "-11px" })[0].outerHTML, { width: "100%", height: "auto" })[0].outerHTML;
                    else
                        chartDiv = ej.buildTag("div#" + this._id + "_chartPanel.e-chartPanel", ej.buildTag("div.e-chartContainer", ej.buildTag("div#" + this._id + "_PivotChart", "", { "min-height": this.model.enablePaging ? "255px" : "", "border": this.model.enableToolBar ? "none" : "" })[0].outerHTML, { "position": "relative", "overflow": this.model.enableToolBar || this.model.enableSplitter || this.model.isResponsive ? "" : "auto", "padding": this.model.enableToolBar ? "5px 0px 5px 0px" : "5px 0px 5px 5px", "width": (this.model.isResponsive) ? "99.6%" : (this.model.enableSplitter ? "inherit" : "") })[0].outerHTML, { width: "98%", height: "auto" })[0].outerHTML;
                }
                else {
                    if (this.displayMode() == ej.PivotClient.DisplayMode.ChartOnly)
                        chartDiv = ej.buildTag("div#" + this._id + "_chartPanel.e-chartPanel", ej.buildTag("div.e-chartContainer", ej.buildTag("div#" + this._id + "_PivotChart", "", { "border": this.model.enableToolBar ? "none" : "" })[0].outerHTML, { "position": "relative", "overflow": this.model.enableToolBar || this.model.enableSplitter || this.model.isResponsive ? "" : "auto", "padding": this.model.enableRTL ? (this.model.enableSplitter && !this.model.isResponsive ? "5px 4px 2px 6px" : "5px 25px 2px 6px") : (this.model.enableToolBar ? "5px 0px 5px 0px" : "5px 0px 5px 5px"), "margin-right": this.model.enableRTL ? "1px" : "-11px" })[0].outerHTML, { width: this.model.enableSplitter ? "96%" : (this.model.isResponsive? "99%" : "98%"), margin: this.model.enableSplitter ? (this.model.enableRTL ? (!(this.model.analysisMode == ej.Pivot.AnalysisMode.Olap && this.model.operationalMode == ej.Pivot.OperationalMode.ServerMode) ? "5px 2px 7px" : "5px -5px 7px") : "5px 5px 7px") : "5px 7px 7px", height: "auto" })[0].outerHTML;
                    else
                        chartDiv = ej.buildTag("div#" + this._id + "_chartPanel.e-chartPanel", ej.buildTag("div.e-chartContainer", ej.buildTag("div#" + this._id + "_PivotChart", "", { "border": this.model.enableToolBar ? "none" : "" })[0].outerHTML, { "position": "relative", "overflow": this.model.enableToolBar || this.model.enableSplitter || this.model.isResponsive ? "" : "auto", "top": "-5px", "left": window.navigator.userAgent.indexOf('Trident') > 0 ? (this.model.enableSplitter ? "-1px" : "-7px") : (this.model.enableRTL ? "12px" : "0px"), "padding": this.model.enableRTL ? "5px 5px 0px 5px" : (this.model.enableToolBar ? "5px 0px 5px 0px" : "5px 0px 5px 5px"), "border-top": "none", "margin-right": this.model.enableRTL ? "0px" : (this.model.enableSplitter ? "-9px" : "-11px"), "margin-left": this.model.enableRTL ? "-11px" : "0px" })[0].outerHTML, { margin: this.model.enableSplitter ? (this.model.enableRTL ? "5px -3px 7px" : "5px 5px 7px") : (this.model.analysisMode == ej.Pivot.AnalysisMode.Olap && this.model.operationalMode == ej.Pivot.OperationalMode.ServerMode ? "5px 5px 7px" : "5px 7px 7px"), width: this.model.isResponsive ? (this.model.enableSplitter ? (this.model.enableRTL ? "96%" : "99%") : "98.5%") : "98.5%", left: this.model.enableSplitter ? "7px" : "", height: "auto" })[0].outerHTML;
                }
            }
            if (this.controlPlacement() == ej.PivotClient.ControlPlacement.Tab && this.displayMode() == ej.PivotClient.DisplayMode.ChartAndGrid) {
                ...
                var gridAnchor = "<a style='font: bold 12px Segoe UI' href='#" + this._id + "_gridPanel' tabindex='0'>" + this._getLocalizedLabels("Grid") + "</a>";
                var chartAnchor = "<a style='font: bold 12px Segoe UI' href='#" + this._id + "_chartPanel' tabindex='0'>" + this._getLocalizedLabels("Chart") + "</a>";
                ...
                if (this.defaultView() == ej.PivotClient.DefaultView.Chart) {
                    ...
                    tabDiv = ej.buildTag("div#" + this._id + "_clientTab", tabUl + chartDiv + gridDiv)[0].outerHTML;
                }
                else {
                    ...
                    tabDiv = ej.buildTag("div#" + this._id + "_clientTab", tabUl + gridDiv + chartDiv, { "height": "100%" })[0].outerHTML;
                }
                controlTable = tabDiv;
            }
            else {
        ...
        _createDialog: function (args_className, args_innerHTML, editorTree) {
            ...
            var ejDialog = ej.buildTag("div#" + (this.model.enableAdvancedFilter ? (this._id + "_clientDialog") : (this._id + "_ClientDialog")) + ".e-clientDialog", { "opacity": "1" })[0].outerHTML;
            ...
            if (args_className.split(" ")[0] == "e-newReportImg") {
                ...
                var newReport = "<input type=text id=" + this._id + "_reportName class='reportName'/></br>";
                ...
                var addReport = "<input type=text id=" + this._id + "_reportName class='reportName'/></br>";
                ...
                var sortingLbl = ej.buildTag("label#" + this._id + "_sortingLbl.e-sortingLbl", this._getLocalizedLabels("Sorting"))[0].outerHTML;
                var measureListLbl = ej.buildTag("label#" + this._id + "_measureListLbl.e-measureListLbl", this._getLocalizedLabels("Measure"))[0].outerHTML;
                var orderLbl = ej.buildTag("label#" + this._id + "_orderLbl.e-orderLbl", this._getLocalizedLabels("Order"))[0].outerHTML;
                var measureListDropDown = ej.buildTag("input#" + this._id + "_measuresList.e-measuresList", "", {}, { type: 'text', accesskey: 'M' })[0].outerHTML;

                var sortDisableRadio = ej.buildTag("input#" + this._id + "_sortDisable.e-sortDisable", "", {}, { name: "sort", type: "radio", checked: 'checked', tabindex: 0, accesskey: 'i' })[0].outerHTML + ej.buildTag("label.e-sortDisableLbl", this._getLocalizedLabels("Disable"))[0].outerHTML;
                var sortEnableRadio = ej.buildTag("input#" + this._id + "_sortEnable.e-sortEnable", "", {}, { name: 'sort', type: 'radio', tabindex: 1, accesskey: 'n' })[0].outerHTML + ej.buildTag("label.e-sortEnableLbl", this._getLocalizedLabels("Enable"))[0].outerHTML + "<br/>";
                var newascRadio = ej.buildTag("input#" + this._id + "_radioBtnAsc.e-radioBtnAsc", "", {}, { name: 'order', type: 'radio', checked: 'checked', tabindex: 0, accesskey: 'A' })[0].outerHTML + ej.buildTag("label.e-radioBtnAscLbl", this._getLocalizedLabels("Ascending"))[0].outerHTML + "<br/>";
                var newdescRadio = ej.buildTag("input#" + this._id + "_radioBtnDesc.e-radioBtnDesc", "", {}, { name: 'order', type: 'radio', tabindex: 2, accesskey: 'e' })[0].outerHTML + ej.buildTag("label.e-radioBtnDescLbl", this._getLocalizedLabels("Descending"))[0].outerHTML;
                var preservHierarchy = ej.buildTag("input#" + this._id + "_preserveHrchy.e-preserveHrchy", "", {}, { type: 'checkbox', checked: 'checked', tabindex: 0, accesskey: 'r' })[0].outerHTML + ej.buildTag("label.e-preserveHrchyLbl", this._getLocalizedLabels("PreserveHierarchy"))[0].outerHTML;

                var filter = ej.buildTag("label#" + this._id + "_filterLbl.e-filterLbl", this._getLocalizedLabels("Filtering"))[0].outerHTML;
                var filterDisableRadio = ej.buildTag("input#" + this._id + "_filterDisable.e-filterDisable", "", {}, { name: 'filter', type: 'radio', checked: 'checked', tabindex: 0, accesskey: 'i' })[0].outerHTML + ej.buildTag("label.e-filterDisableLbl", this._getLocalizedLabels("Disable"))[0].outerHTML;
                var filterEnableRadio = ej.buildTag("input#" + this._id + "_filterEnable.e-filterEnable", "", {}, { name: 'filter', type: 'radio', tabindex: 0, accesskey: 'n' })[0].outerHTML + ej.buildTag("label.e-filterDisableLbl", this._getLocalizedLabels("Enable"))[0].outerHTML + "<br/>";
                var conditionLbl = ej.buildTag("label#" + this._id + "_conditionLbl.e-conditionLbl", this._getLocalizedLabels("Condition"))[0].outerHTML;
                var conditionDropDown = ej.buildTag("input#" + this._id + "_filterCondition.e-filterCondition", "", {}, { type: 'text', tabindex: 0, accesskey: 'o' })[0].outerHTML;

                var filterFrom = ej.buildTag("div#" + this._id + "_filterfrom.e-filterFrmDiv", ej.buildTag("input#" + this._id + "_filterFrom.filterFrom" + (ej.isMobile() ? " inputConditionMbl" : ""), "", {}, { name: 'inputVal', type: ej.isMobile() ? 'number' : 'text', inputmode: ej.isMobile() ? 'numeric' : '', pattern: ej.isMobile() ? '[0-9]*' : '', tabindex: 0 })[0].outerHTML)[0].outerHTML;
                var filterbtw = ej.buildTag("div#" + this._id + "_filterbtw.e-filterBtw", "<p>" + this._getLocalizedLabels("and") + "</p>")[0].outerHTML;
                var filterTo = ej.buildTag("div#" + this._id + "_filterto.e-filterToDiv", ej.buildTag("input#" + this._id + "_filterTo.filterTo" + (ej.isMobile() ? " inputConditionMbl" : ""), "", {}, { name: 'inputVal', type: ej.isMobile() ? 'number' : 'text', inputmode: ej.isMobile() ? 'numeric' : '', pattern: ej.isMobile() ? '[0-9]*' : '', tabindex: 0, accesskey: 'd' })[0].outerHTML)[0].outerHTML;
                var fMeasureListLbl = ej.buildTag("label#" + this._id + "_filterMeasureListLbl.filterMeasureListLbl", this._getLocalizedLabels("Measure"))[0].outerHTML;
                var fMeasureList = ej.buildTag("input#" + this._id + "_fMeasuresList.fMeasuresList", "", {}, { type: 'text', tabindex: 0, accesskey: 'M' })[0].outerHTML;
                var fValueLbl = ej.buildTag("label#" + this._id + "_filterValueLbl.e-filterValueLbl", this._getLocalizedLabels("Value"), {}, { tabindex: 0, accesskey: 'a' })[0].outerHTML;

                var sortDiv = ej.buildTag("div#" + this._id + "_sortingDlg.e-sortingDlg", "<table class='e-sortReportTbl'><tr><td style='vertical-align:top;'>" + sortingLbl + "</td><td>" + sortEnableRadio + sortDisableRadio + "</td></tr><tr><td>" + measureListLbl + "</td><td>" + measureListDropDown + "</td></tr> <tr><td>" + orderLbl + "</td><td>" + newascRadio + newdescRadio + "</td></tr><tr><td></td><td>" + preservHierarchy + "</td></tr></table>")[0].outerHTML;
                var filterDiv = ej.buildTag("div#" + this._id + "_filteringDlg.e-filteringDlg", "<table class='e-sortReportTbl'><tr><td>" + filter + "</td><td>" + filterEnableRadio + filterDisableRadio + "</td></tr><tr><td>" + fMeasureListLbl + "</td><td>" + fMeasureList + "</td></tr><tr><td>" + conditionLbl + "</td><td>" + conditionDropDown + "</td></tr><tr><td>" + fValueLbl + "</td><td>" + filterFrom + filterbtw + filterTo + "</td></tr></table>")[0].outerHTML;

                var sortTab = "<li><a style='font: bold 12px Segoe UI' href='#" + this._id + "_sortingDlg'>" + this._getLocalizedLabels("Sorting") + "</a></li>";
                var filterTab = "<li><a style='font: bold 12px Segoe UI' href='#" + this._id + "_filteringDlg'>" + this._getLocalizedLabels("Filtering") + "</a></li>";
                var sortfilterTab = ej.buildTag("div#" + this._id + "_sortfilterTab.sortfilterTab", "<ul class ='e-sortfiltTab'>" + (sortTab + filterTab + "</ul>" + sortDiv + filterDiv))[0].outerHTML;
                ...
                var renameReport = "<input type=text id=" + this._id + "_reportName class='reportName' value='" + currentReportName + "' /></br>";
                ...
                var recordName = "<input type=text id=" + this._id + "_reportName class='reportName'/></br>";
                ...
                var recordNamesDropdown = "<td><input type='text' id='" + this._id + "_reportNameList' class='reportNameList'/></td></tr></table>";
                ...
                var recordNamesDropdown = "<td><input type='text' id='" + this._id + "_reportNameList' class='reportNameList'/></td></tr>";
                var renameLabel = "<tr><td class='e-renameDBReportTd'>" + this._getLocalizedLabels("RenameReport") + "</td>";
                var renameRecordTxtBox = "<td><input type='text' id='" + this._id + "_renameReport' class='renameReport' style='width:146px'/></td></tr></table>";
                ...
                reportName = "<input type=text id=" + this._id + "_reportName class='reportName'/></br>";
                ...
                if (args_innerHTML != this._getLocalizedLabels("Measures")) {
                    ...
                    memberSearchEditor = ej.buildTag("div.e-memberSearchEditorDiv", ej.buildTag("input#" + this._id + "_searchEditorTreeView.searchEditorTreeView").attr("type", "text")[0].outerHTML + (!ej.isNullOrUndefined(editorTreeInfo) && args_innerHTML != this._getLocalizedLabels("Measures") && this.model.enableMemberEditorPaging && $.parseJSON(editorTreeInfo).length >= this.model.memberEditorPageSize ? ej.buildTag("span.e-icon e-searchEditorTree", {})[0].outerHTML : ""), { "padding": (this.model.enableAdvancedFilter ? "5px 0px 0px 0px" : 0) })[0].outerHTML;
                }
                if (args_innerHTML == this._getLocalizedLabels("Measures")) {
                    this._isMembersFiltered = false;
                    ...
                    memberEditor = ej.buildTag("div#" + this._id + "_editorTreeView.e-editorTreeView")[0].outerHTML;
                ...
                if (this._selectedFieldName != "" && !isSlicerAxis && this.model.enableAdvancedFilter) {
                    levelList = ej.buildTag("div.e-ddlGroupWrap", this._getLocalizedLabels("SelectField") + ":" + ej.buildTag("input#" + this._id + "_GroupLabelDrop.groupLabelDrop").attr("type", "text")[0].outerHTML, {})[0].outerHTML;
                ...
                var EditorDiv = ej.buildTag("div#" + this._id + "_EditorDiv.e-editorDiv", innerDiv, { "margin-left": this.model.enableAdvancedFilter ? "5px" : "0px" })[0].outerHTML;
                dialogContent += EditorDiv;
                editorNavPanel = ej.buildTag("div.e-memberPager", ej.buildTag("div#" + this._id + "_NextpageDiv.e-nextPageDiv", ej.buildTag("div.e-icon e-media-backward_01 e-firstPage", {})[0].outerHTML + ej.buildTag("div.e-icon e-arrowhead-left e-prevPage", {})[0].outerHTML + ej.buildTag("input.e-memberCurrentPage#" + this._id + "_memberCurrentPage", {}, { "width": "20px", "height": "10px" })[0].outerHTML + ej.buildTag("span.e-memberPageCount#" + this._id + "_memberPageCount")[0].outerHTML + ej.buildTag("div.e-icon e-arrowhead-right e-nextPage", {})[0].outerHTML + ej.buildTag("div.e-icon e-media-forward_01 e-lastPage", {})[0].outerHTML)[0].outerHTML, {})[0].outerHTML;
                editorSearchNavPanel = ej.buildTag("div.e-memberSearchPager", ej.buildTag("div#" + this._id + "_NextSearchpageDiv.e-nextPageDiv", ej.buildTag("div.e-icon e-media-backward_01 e-firstPage", {})[0].outerHTML + ej.buildTag("div.e-icon e-arrowhead-left e-prevPage", {})[0].outerHTML + ej.buildTag("input.e-memberCurrentSearchPage#" + this._id + "_memberCurrentSearchPage", {}, { "width": "20px", "height": "10px" })[0].outerHTML + ej.buildTag("span.e-memberSearchPageCount#" + this._id + "_memberSearchPageCount")[0].outerHTML + ej.buildTag("div.e-icon e-arrowhead-right e-nextPage", {})[0].outerHTML + ej.buildTag("div.e-icon e-media-forward_01 e-lastPage", {})[0].outerHTML)[0].outerHTML, {}).css("display", "none")[0].outerHTML;
                editorDrillNavPanel = ej.buildTag("div.e-memberDrillPager", ej.buildTag("div#" + this._id + "_NextDrillpageDiv.e-nextPageDiv", ej.buildTag("div.e-icon e-media-backward_01 e-firstPage", {})[0].outerHTML + ej.buildTag("div.e-icon e-arrowhead-left e-prevPage", {})[0].outerHTML + ej.buildTag("input.e-memberCurrentDrillPage#" + this._id + "_memberCurrentDrillPage", {}, { "width": "20px", "height": "10px" })[0].outerHTML + ej.buildTag("span.e-memberDrillPageCount#" + this._id + "_memberDrillPageCount")[0].outerHTML + ej.buildTag("div.e-icon e-arrowhead-right e-nextPage", {})[0].outerHTML + ej.buildTag("div.e-icon e-media-forward_01 e-lastPage", {})[0].outerHTML)[0].outerHTML, {}).css("display", "none")[0].outerHTML;
            ...
            if (args_className.split(" ")[0] == "mdx") {
                var cancelBtn = "<button id=" + this._id + "_CancelBtn class='e-dialogCancelBtn' title=" + this._getLocalizedLabels("OK").replace(/(<([^>]+)>)/ig, "") + " >" + this._getLocalizedLabels("OK") + "</button>";
                ...
                var okBtn = "<button id=" + this._id + "_OKBtn class='e-dialogOKBtn' title=" + (args_className.split(" ")[0] == "RemoveDBReport" ? this._getLocalizedLabels("Remove") : this._getLocalizedLabels("OK").replace(/(<([^>]+)>)/ig, "")) + ">" + (args_className.split(" ")[0] == "RemoveDBReport" ? this._getLocalizedLabels("Remove") : this._getLocalizedLabels("OK")) + "</button>";
                var cancelBtn = "<button id=" + this._id + "_CancelBtn class='e-dialogCancelBtn' title=" + this._getLocalizedLabels("Cancel").replace(/(<([^>]+)>)/ig, "") + ">" + this._getLocalizedLabels("Cancel") + "</button>";
            ...
            if (editorTree != "" && editorTree != undefined && args_innerHTML != this._getLocalizedLabels("Measures")) {
                ...
                if (this.model.enableAdvancedFilter) {
                    this.element.find("#" + this._id + "_clientDialog_wrapper").addClass("e-advancedFilterDlg");
                    if (this.model.analysisMode == ej.Pivot.AnalysisMode.Olap && this.model.operationalMode == ej.Pivot.OperationalMode.ServerMode)
                        this.element.find("#" + this._id + "_clientDialog_wrapper").addClass("e-advanceFltrElement");
                }
            }
            if (this.model.enableMemberEditorSorting) {
                this._sortType = "";
        ...
        _nodeDropped: function (sender) {
            ...
            for (var i = 0; i < pvtBtns.length; i++) {
                if (!ej.isNullOrUndefined($(sender.droppedElement).attr("data-parentuniquename")) && !ej.isNullOrUndefined($($(pvtBtns)[i]).attr("data-parenthierarchy")) && $($(pvtBtns)[i]).attr("data-parenthierarchy") == $(sender.droppedElement).attr("data-parentuniquename")) {
                    ...
                    var dialogElem = ej.buildTag("div.data-namedSetDialog#" + this._id + "_NamedSetDialog", ej.buildTag("div.data-namedSetDialogContent", dlgContent)[0].outerHTML + ej.buildTag("div", ej.buildTag("button#" + this._id + "_OKBtn.e-okBtn", "OK", { "margin": "20px 0 10px 120px" }).attr("title", "OK")[0].outerHTML + ej.buildTag("button#" + this._id + "_CancelBtn.e-cancelBtn", "Cancel", { "margin": "20px 0 10px 10px" }).attr("title", "Cancel")[0].outerHTML)[0].outerHTML).attr("title", "Warning")[0].outerHTML;
        ...
        _cubeChanged: function (sender) {
            ...
            var reportList = this.element.find('#' + this._id + '_reportList').data("ejDropDownList");
            var cubeList = pivotClientObj.element.find('#' + this._id + '_cubeSelector').data("ejDropDownList");
        ...
        _updateSlicerBtnText: function (cubeName) {
            var reportIdx = this.element.find('#' + this._id + '_reportList').data("ejDropDownList").selectedIndexValue;
