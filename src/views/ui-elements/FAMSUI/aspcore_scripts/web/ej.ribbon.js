...
*/
(function (fn) {
    typeof define === 'function' && define.amd ? define(["./../common/ej.core","./../common/ej.globalize","./ej.dropdownlist","./ej.button","./ej.tab","./ej.splitbutton","./ej.menu","./../common/ej.scroller","./ej.checkbox","./ej.togglebutton","./ej.waitingpopup"], fn) : fn();
})
(function () {
