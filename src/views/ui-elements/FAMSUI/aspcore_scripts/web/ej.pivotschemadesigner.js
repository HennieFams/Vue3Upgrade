...
*/
(function (fn) {
    typeof define === 'function' && define.amd ? define(["./../common/ej.core","./../common/ej.data","./../common/ej.touch","./../common/ej.draggable","./../common/ej.scroller","./ej.menu","./ej.togglebutton","./ej.button","./ej.checkbox","./ej.dialog","./ej.maskedit","./ej.waitingpopup","./ej.treeview","./../datavisualization/ej.chart"], fn) : fn();
})
(function () {
    ...
    ej.widget("ejPivotSchemaDesigner", "ej.PivotSchemaDesigner", {
        ...
        _load: function () {
            ...
            if (!this.model.enableWrapper) {
                var fieldTable =
                    ...
                    ((this.model.pivotControl != null && this.model.pivotControl.model.operationalMode == ej.Pivot.OperationalMode.ClientMode && this.model.pivotControl.model.analysisMode == ej.Pivot.AnalysisMode.Olap && this.model.layout == ej.PivotSchemaDesigner.Layouts.OneByOne) ? ej.buildTag("div.e-cubelists", ej.buildTag("input#" + this._id + "_cubeList.cubeList").attr("type", "text")[0].outerHTML)[0].outerHTML : "") +
            ...
            (this._dataModel != "XMLA" || this.model.pivotCalculations.length == 0 ? "" : (this.model.pivotCalculations[0]["measures"] != undefined && this.model.pivotCalculations[0]["measures"].length > 0 && this.model.pivotCalculations[0]["axis"] != undefined && this.model.pivotCalculations[0]["axis"] == "columns" ? this._createPivotButtons("columns", [{ fieldName: "Measures", fieldCaption: this._getLocalizedLabels("Measures") }]) : "")), {})[0].outerHTML, {}).attr("aria-label", "column label").attr("aria-dropeffect", "none").attr("aria-selected", "false")[0].outerHTML;
                ...
                var rowAxis =
                ej.buildTag("div.e-axisTd1#" + this._id + "_axisTd", ej.buildTag("div.e-pivotHeader", ej.buildTag("span.headerText", this._getLocalizedLabels("RowLabel"), {})[0].outerHTML, {})[0].outerHTML +
            ...
            (this._dataModel != "XMLA" || this.model.pivotCalculations.length == 0 ? "" : (this.model.pivotCalculations[0]["measures"] != undefined && this.model.pivotCalculations[0]["measures"].length > 0 && this.model.pivotCalculations[0]["axis"] != undefined && this.model.pivotCalculations[0]["axis"] == "rows" ? this._createPivotButtons("rows", [{ fieldName: "Measures", fieldCaption: this._getLocalizedLabels("Measures") }]) : "")), {})[0].outerHTML, {}).attr("aria-label", "row label").attr("aria-dropeffect", "none").attr("aria-selected", "false")[0].outerHTML;
                ...
                var values =
                ej.buildTag("div.e-axisTd2#" + this._id + "_axisTd3", ej.buildTag("div.e-rPivotHeader", ej.buildTag("span.headerText", this._getLocalizedLabels("Values"), {})[0].outerHTML, {})[0].outerHTML +
        ...
        _cubeChanged: function (args) {
            if (this.model.pivotControl.model.dataSource.cube != args.selectedValue) {
                ...
                var reportList = this.model.pivotControl.element.find('#' + this._id + '_reportList').data("ejDropDownList");
        ...
        _contextClick: function (args) {
             if ($(args.element).hasClass("summarytype")) {
                var selectedValue = args.element.id.split('_')[args.element.id.split('_').length - 1];
                if (selectedValue != null) {
                    ...
                    if (pivotClient.model.analysisMode == ej.Pivot.AnalysisMode.Pivot && pivotClient.model.operationalMode == ej.Pivot.OperationalMode.ClientMode) {
                        ...
                        if (JSON.parse(pivotClient.getOlapReport()).PivotCalculations.length >= 1) 
                            {
                                var selectedValue = this._selectedMember[0].dataset.fieldname
                                var value = args.element.id.split('_')[args.element.id.split('_').length - 1];
        ...
        _createTreeView: function (args, dataSourceInfo) {
            ...
            if (this.model.pivotControl != null) {
                var contextTag = ej.buildTag("ul.pivotTreeContext#" + this._id + "_pivotTreeContext",
                    ...
                    ej.buildTag("li#" + this._id + "_e-remove", ej.buildTag("a", this._getLocalizedLabels("Remove"))[0].outerHTML)[0].outerHTML
                    )[0].outerHTML;
       ...
       _nodeDraged: function (args) {
        ...
        _nodeCheckChanges: function (args) {
            if (this._onDemandNodeExpand) {
                ...
                else if (((!ej.isNullOrUndefined(args.model.id) && args.model.id.toLowerCase() == this._id.toLowerCase() + "_allelement") || (!ej.isNullOrUndefined(args.id) && (args.id.toLowerCase() == "(all)_0" || args.id.toLowerCase() != "all"))) && !ej.isNullOrUndefined(this.model.pivotControl) && (this.model.pivotControl.model.enableMemberEditorPaging || this._editorTreeData.length > 0)) {
            ...
            if (!ej.isNullOrUndefined(this.model.pivotControl) && this.model.pivotControl.model.operationalMode == ej.Pivot.OperationalMode.ClientMode) {
                ...
                for (var i = 0; i < items.length; i++) {
                    ...
                    rowBtns += ej.buildTag("div.e-pivotButton",
                                    ...
                                    ($(this.element).parents(".e-pivotclient").length > 0 ? (ej.buildTag("button.e-pvtBtn#" + this._id + "_pivotButton" + buttonId, (this.model.pivotControl.model.analysisMode == ej.Pivot.AnalysisMode.Olap ? (this.model.pivotControl.model.showUniqueNameOnPivotButton ? (axis != "values" ? (items[i].fieldName.replace(/\[/g, '').replace(/\]/g, '')) : (items[i].fieldCaption != undefined ? items[i].fieldCaption : items[i].fieldName) || items[i]) : (items[i].fieldCaption != undefined ? items[i].fieldCaption : items[i].fieldName) || items[i]) : fldName || fldCaption) + (axis == "filters" && filterState != "" ? " (" + filterState + ")" : ""), {}, { "data-fieldName": items[i].fieldName || items[i], "data-fieldCaption": items[i].fieldCaption || items[i].fieldName, "data-axis": axis })[0].outerHTML) : (ej.buildTag("div.pvtBtnDiv", ej.buildTag("button.e-pvtBtn#" + this._id + "_pivotButton" + buttonId, (this.model.pivotControl.model.analysisMode == ej.Pivot.AnalysisMode.Olap ? (this.model.pivotControl.model.showUniqueNameOnPivotButton ? (axis != "values" ? (items[i].fieldName.replace(/\[/g, '').replace(/\]/g, '')) : (items[i].fieldCaption != undefined ? items[i].fieldCaption : items[i].fieldName) || items[i]) : (items[i].fieldCaption != undefined ? items[i].fieldCaption : items[i].fieldName) || items[i]) : fldName || fldCaption) + (axis == "filters" && filterState != "" ? " (" + filterState + ")" : ""), {}, { "data-fieldName": items[i].fieldName || items[i], "data-fieldCaption": items[i].fieldCaption || items[i].fieldName, "data-axis": axis })[0].outerHTML).attr("data-tag", axis + ":" + items[i].fieldName)[0].outerHTML)) +
        ...
        _createErrorDialog: function () {
            ...
            if (this.element.find(".e-errorDialog").length == 0) {
                var dialogElem = ej.buildTag("div.e-errorDialog#" + this._id + "_ErrorDialog", ej.buildTag("div.warningImg")[0].outerHTML + ej.buildTag("div.warningContent", this._getLocalizedLabels("AlertMsg"))[0].outerHTML + ej.buildTag("div", ej.buildTag("button#" + this._id + "_ErrOKBtn.e-errOKBtn", "OK")[0].outerHTML)[0].outerHTML).attr("title", this._getLocalizedLabels("Warning"))[0].outerHTML;
        ...
        _reSizeHandler: function (args) {
            if (this.model && this.model.pivotControl) {
                ...
                if (this.model.pivotControl != null && (!this.model.pivotControl.element.hasClass("e-pivotclient")) && this.model.pivotControl.model.operationalMode == ej.PivotGrid.OperationalMode.ServerMode) {
                    ...
                    this.element.find("#" + this._id + "_axisTd","#" + this._id + "_axisTd3").css("margin-top", "5px");
                }
                ...
                if (args.model.text.toLowerCase() != "cancel") {
                    ...
                    if (this.model.pivotControl.model.enableGroupingBar) {
                        ...
                        if (this.model.pivotControl.model.analysisMode == ej.Pivot.AnalysisMode.Pivot ? uncheckedNodes.length > 0 : uncheckedNodes.split("FILTERED::")[0].length > 0)
                            this.model.pivotControl.element.find("#" + this._id + "_pivotButton" + this._curFilteredText.split('.')[0]).next().addClass("filtered");;
                    }
                    var report;
                    try {
                        report = JSON.parse(this.model.pivotControl.getOlapReport()).Report;
                ...
                if (this.model.pivotControl.model.analysisMode == ej.Pivot.AnalysisMode.Pivot && this.model.pivotControl.model.operationalMode == ej.Pivot.OperationalMode.ServerMode) {
                  ...
                  if (!ej.isNullOrUndefined(pivotclientObj._clientReportCollection)) {
                    for (var i = 0; i < pivotclientObj._clientReportCollection.length; i++) {
                        if (pivotclientObj._clientReportCollection[i].fieldSelectedMembers != undefined && pivotclientObj.element.find("#" + this._id + "_reportList")[0].value == pivotclientObj._clientReportCollection[i].name)
        ...
        _createDialog: function (title, treeViewData) {
            ...
            var dialogContent = ej.buildTag("div#" + this._id + "_EditorDiv.e-editorDiv", groupDropDown + filterElementTag + ej.buildTag("div", memberSearchEditor + ej.buildTag("div.e-memberEditorDiv", ej.buildTag("div#" + this._id + "_editorTreeView.e-editorTreeView")[0].outerHTML)[0].outerHTML)[0].outerHTML)[0].outerHTML + ((!ej.isNullOrUndefined(treeViewData) && this.model.pivotControl.model.enableMemberEditorPaging && ($.parseJSON(treeViewData).length >= this.model.pivotControl.model.memberEditorPageSize || this.model.pivotControl.model.memberEditorPageSize < this._memberPageSettings.endPage)) ? "" : "</br>"),
            dialogFooter = ej.buildTag("div.e-footerArea", ej.buildTag("button#" + this._id + "_OKBtn.e-dialogOKBtn", this._getLocalizedLabels("OK")).attr({ "title": this._getLocalizedLabels("OK"), tabindex: 0 })[0].outerHTML + ej.buildTag("button#" + this._id + "_CancelBtn.e-dialogCancelBtn", this._getLocalizedLabels("Cancel")).attr({ "title": this._getLocalizedLabels("Cancel"), tabindex: 0 })[0].outerHTML, { "float": "right", "margin": (!ej.isNullOrUndefined(treeViewData) && $.parseJSON(treeViewData).length >= this.model.pivotControl.model.memberEditorPageSize && this.model.pivotControl.model.enableMemberEditorPaging ? "10px" : "-12px ") + " " + (isAdvancedFilter ? " 5px " : " 0px ") + " 6px 0px" })[0].outerHTML,
            ...
            if (isAdvancedFilter) {
                ...
                this.element.find("#" + this._id + "_clientDialog_wrapper").css("min-width", "265px");
                if (this._droppedClass != "e-schemaFilter") {
        ...
        _filterElementClick: function (args) {
            ...
            if (!ej.isNullOrUndefined(args.element))
                this._filterAction = $(args.element).parents("li:eq(0)#" + this._id + "_valueFilterBtn").length == 0 ? "labelFiltering" : "valueFiltering";
            else
        ...
        _filterElementOkBtnClick: function (args) {
            var selectedOperator = this.element.find(".filterOptions")[0].value,
                ...
                filter2TxtBx = (this.element.find("#" + this._id + "_filterValue2").length > 0 ? this.element.find("#" + this._id + "_filterValue2")[0].value : ""),
        ...
        _groupLabelChange: function (args) {
            ...
            if (this.model.pivotControl && this.model.pivotControl.model.operationalMode == ej.Pivot.OperationalMode.ServerMode) {
                ...
                this.element.find("#" + this._id + "_labelClearFilter" ,"#" + this._id + "_valueClearFilter").css("opacity", "0.5").attr("disable", true);
            ...
            if (reportItem) {
                if (reportItem["sortOrder"] && reportItem["sortOrder"] != ej.olap.SortOrder.None) {
                    ...
                    this.element.find("#" + this._id + "_clearSorting").css("opacity", "0.5").attr("disabled", "disabled");
            }
            this.element.find("#" + this._id + "_clearAllFilters").css("opacity", "0.5").attr("disabled", "disabled");
            ...
            if (filterData.length > 0) {
                ...
                filterMenuObj.enableItemByID("clearAllFilters");
                this.element.find("#" + this._id + "_clearAllFilters").css("opacity", "1").removeAttr("disabled");
            }
        ...
        _createPivotButton: function (text, axis, isFiltered, isSorted, dropPostion) {
            ...
            if (this.model.pivotControl.model.operationalMode == ej.PivotGrid.OperationalMode.ClientMode) {
                ...
                filterBtn = (axis == "column" || axis == "row" || axis == "filter") && this.model.layout != "excel" && text.fieldCaption != "Measures" ? ej.buildTag("span.filter e-icon " + filtered).attr("role", "button").attr("aria-label", "filter")[0].outerHTML : "",
                removeBtn = this.model.layout != "excel" ? ej.buildTag("span.e-removeBtn e-icon").attr("role", "button").attr("aria-label", "remove")[0].outerHTML : "",
                rowBtn = ej.buildTag("div.e-pivotButton", ej.buildTag("div.e-dropIndicator")[0].outerHTML + ej.buildTag("div.pvtBtnDiv", ej.buildTag("button.e-pvtBtn#" + this._id + "_pivotButton" + text.fieldName, ((this._dataModel == "Pivot" ? (text.fieldCaption) : (text == "Measures" ? text : (!ej.isNullOrUndefined(text["fieldCaption"]) && text["fieldCaption"] != "" ? text["fieldCaption"] : text.fieldName.split(".")[1]))) + (filterState != "" ? (" (" + filterState + ")") : "")), {}, { "data-fieldName": text.fieldName, "data-fieldCaption": text.fieldCaption, "data-axis": tagAxis })[0].outerHTML +
            ...
            if (!ej.isNullOrUndefined(rows)) {
                ...
                if (this.model.pivotControl != null && this.model.pivotControl.model.operationalMode == ej.PivotGrid.OperationalMode.ClientMode) {
                    ...
                    for (var i = 0; i < rows.length; i++) {
                        ...
                        removeBtn = this.model.layout != "excel" ? ej.buildTag("span.e-removeBtn e-icon").attr("role", "button").attr("aria-label", "remove")[0].outerHTML : "";
                        rowBtns += ej.buildTag("div.e-pivotButton", ej.buildTag("div.e-dropIndicator")[0].outerHTML + ej.buildTag("div.pvtBtnDiv", ej.buildTag("button.e-pvtBtn#" + this._id + "_pivotButton" + rows[i].FieldHeader || rows[i].FieldName || rows[i].Name || rows[i].DimensionName, rows[i].FieldHeader || rows[i].FieldName || rows[i].Name || rows[i].DimensionName)[0].outerHTML +
