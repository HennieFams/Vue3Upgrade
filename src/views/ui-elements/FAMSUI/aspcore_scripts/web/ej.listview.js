...
*/
(function (fn) {
    typeof define === 'function' && define.amd ? define(["jsrender","./../common/ej.globalize","./../common/ej.core","./../common/ej.data","./../common/ej.scroller","./../common/ej.touch","./ej.checkbox"], fn) : fn();
})
(function () {
