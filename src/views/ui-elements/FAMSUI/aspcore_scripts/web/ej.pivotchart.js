...
*/
(function (fn) {
    typeof define === 'function' && define.amd ? define(["./../common/ej.globalize","./../common/ej.core","./../common/ej.data","./../common/ej.touch","./../common/ej.draggable","./../common/ej.scroller","./ej.dialog","./ej.waitingpopup","./../datavisualization/ej.chart","./ej.pivotanalysis.base","./ej.olap.base","./ej.pivot.common"], fn) : fn();
})
(function () {
    ...
    ej.widget("ejPivotChart", "ej.PivotChart", {
        ...
        renderControlSuccess: function (msg) {
            ...
            try {
                ...
                if ($(this.element).parents(".e-pivotclient").length > 0 && this._pivotClientObj.model.enableToolBar&& !this._pivotClientObj.model.displaySettings.enableFullScreen) {
                    var toolBar = this._pivotClientObj.model.enableSplitter?$("<div id=" + this._id + "_toolBar style='width:" + this._pivotClientObj._chartWidth + ";height:" + this._pivotClientObj._chartHeight + ";margin-top:35px;margin-left:5px'></div>"):$("<div id=" + this._id + "_toolBar style='width:" + this._pivotClientObj._chartWidth + ";height:" + this._pivotClientObj._chartHeight + ";overflow:auto;margin-top:35px;margin-left:5px'></div>");
        ...
        renderChartFromJSON: function (jsonData) {
            ...
            if (this.model.enableRTL && jsonData != null) {
                var toolTipInfo = ej.buildTag("div#" + this._id + "_toolTipTemplate.e-toolTip",
                   ej.buildTag("div.toolTipInfo",
                    ej.buildTag("div", jsonData.measureNames + " : " + (this._getLocalizedLabels("Measure")) + " <br/>")[0].outerHTML +
                    ej.buildTag("div", "#" + this._id + "_series.name#: " + (this._getLocalizedLabels("Row")) + " <br/>")[0].outerHTML +
                    ej.buildTag("div", "#" + this._id + "_point.x# : " + (this._getLocalizedLabels("Column")) + " <br/>")[0].outerHTML +
                    ej.buildTag("div", "#" + this._id + "_point.y# : " + (this._getLocalizedLabels("Value")))[0].outerHTML//,
