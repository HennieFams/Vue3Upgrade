...
/*global document, jQuery, navigator, clearTimeout, setTimeout, window, Syncfusion, event */
(function ($, ej, undefined) {
    ...
    ej.widget({ "ejTreeMap": "ej.datavisualization.TreeMap" }, {
        ...
        refresh: function (isClear) {
            ...
            var browser = matched.browser.toLowerCase(), header;
   ...
   _renderLegend: function () {
        ...
        _headerClickFunction: function (event) {
			...
			if (!event.cancel && treeMap.enableDrillDown() && treeMap.model.levels.length > 1 && ((treeMap._drilldownItem != null && treeMap._drilldownItem.header != data.header) || treeMap._drilldownItem == null)) {
                    var header = "";
       ...
       _rectMouseDown: function (event) {
        ...
        _drilldownfunction: function (event) {
            ...
            if (!event.cancel && treeMap._drilldownItems.length > 0) {                
