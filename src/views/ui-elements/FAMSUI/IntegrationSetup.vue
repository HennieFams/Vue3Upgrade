        ...
        >
          <tab-content title="Step 1" class="mb-5" icon="feather icon-home">
            ...
            <div class="vx-row">
              ...
              <div class="vx-col md:w-1/2 w-full mt-5">
                <label class="w-full" size="small">Integration</label>
                <v-select
                  class="w-full"
                  placeholder="Search / Select Account"
                ...
                <span
                  class="text-danger text-sm"
                  v-show="errors.has('Search / Select Integration')"
                  >{{
                    errors.first("Search / Select Integration")
                  }}
                </span>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    GetGrid() {
      ...
      self.$ajaxGet(self,"Integrations/GetPerIntegrationAccountAdmin", onSuccess);
    },
  },
};
</script>
