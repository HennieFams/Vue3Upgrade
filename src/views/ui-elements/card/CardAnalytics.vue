                ...
                <vx-card>
                    <div class="vx-row flex-col-reverse lg:flex-row">
                        ...
                        <div class="vx-col w-full lg:w-1/2 xl:w-1/2 flex flex-col justify-between" v-if="salesBarSession.analyticsData">
                            ...
                            <vs-button icon-pack="feather" icon="icon-chevrons-right" icon-after class="rounded-lg shadow-md w-full lg:mt-0 mt-4">View Details</vs-button>
                        </div>
                            ...
                            <li class="px-6 py-4 tasks-today__task" v-for="todo in todoToday.tasksToday" :key="todo.id">
                                <div class="vx-row">
                                    ...
                                    <div class="tasks-today__actions vx-col w-full sm:w-auto ml-auto mt-2 sm:mt-0">
                                        ...
                                        <vs-button radius color="primary" type="border" icon-pack="feather" icon="icon-edit-2" size="small" class="rounded-lg ml-3"></vs-button>
                                        <vs-button radius color="primary" type="border" icon-pack="feather" icon="icon-trash" size="small" class="rounded-lg ml-3"></vs-button>
                                    </div>
                                </div>
                            </li>
                        </ul>
                ...
                <vx-card>
                    <template slot="no-body" v-if="Object.entries(funding).length">
                        <div class="p-8 clearfix">
                            ...
                            <vs-button icon-pack="feather" icon="icon-chevrons-right" icon-after class="rounded-lg shadow-md w-full">Add Funds</vs-button>
                        </div>
