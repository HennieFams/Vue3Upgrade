...
import menuSidebar from "./DocumentCustomerSidebar.vue";
...
export default {
  ...
  FailedNotify() {
    ...
    add(data) {
      ...
      self.$ajaxPost(
        self,
        "SalesSeeker/AddDocumentationCustomer",
        data,
        onSuccess,
        onFinally
      );
    ...
    update(data) {
      ...
      self.$ajaxPost(
        self,
        "SalesSeeker/UpdateDocumentationCustomer",
        data,
        onSuccess,
        onFinally
      );
    ...
    deleteData(data) {
      ...
      self.$ajaxGet(
        self,
        "SalesSeeker/RemoveDocumentationCustomer?DocumentID=" + data.id,
        onSuccess,
        onFinally
      );
    },
    ...
    GetGrid() {
      ...
      self.$ajaxGet(
        self,
         "SalesSeeker/GetDocumentationCustomer?AccountID=1&customerID=" + self.customerID,
        onSuccess,
        onFinally
      );
    },
