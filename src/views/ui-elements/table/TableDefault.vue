...
<template>
    <vx-card title="Default" code-toggler>
        ...
        <p>YES BABY To implement a data table we have the component vs-table, also sub components and slots for a better management of the structure and operation</p>
