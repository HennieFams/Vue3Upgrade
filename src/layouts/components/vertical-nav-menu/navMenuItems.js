...
export default [
...

  {
    ...
    submenu: [
      ...
      {
        name: "Quick Calendar View",
        slug: "Calendar",
        icon: "CreditCardIcon",
        url: "/QuickCalendarView",
      },
      {
        name: "Quick Chart View",
        slug: "Chart",
        icon: "CreditCardIcon",
        url: "/QuickChartView",
      },
      ...
      {
        name: "Quick GPS Info view",
        slug: "Map",
        icon: "MapPin",
        url: "/QuickViewGPSInformation",
      },
  ...
  },
  {
    ...
    submenu: [
      {
        url: "/QuickDispense24",
        name: "Quick Dispense24",
        slug: "QuickDispense24",
        i18n: "QuickDispense24",
      },
      // {
      //   url: "/QuickBalancing",
      //   name: "Quick Balancing",
  ...
  //     },
  //     {
  //       url: "/StandardCustomReportList",
  //       name: "Standard Reports",
  //       slug: "StandardReports",
  //       icon: "UsersIcon",
  //     }
  //   ]
  // },
  ...
  {
    name: "FAMS Allocation",
    slug: "FAMS Allocation",
    icon: "BriefcaseIcon",
    submenu: [
      {
        url: "/Allocation",
...

      {
        ...
        slug: "Custom Allocation" ,
        i18n: "Custom Allocation",
      },
    ]
  },
  {
    ...
    submenu: [
      ...
      {
        url: "/F24BusinessRules",
        name: "F24BusinessRules",
        slug: "F24BusinessRules"
      },
    ]
  },
  // {
  ...
  // },
  {
    ...
    submenu: [
      {
        url: "/FiltersDispensing",
        name: "Filters - Dispensing",
        slug: "FiltersDispensing",
       // i18n: "PowerbiAdmin",
      },
      {
        url: "/FiltersReceived",
        name: "Filters - Received",
        slug: "FiltersReceived",
       // i18n: "PowerbiAdmin",
      },
      {
        url: "/FiltersReceivedMan",
        name: "Filters - Rec Manually",
        slug: "FiltersReceivedMan",
       // i18n: "PowerbiAdmin",
      },
      {
        url: "/FiltersTransfer",
        name: "Filters - Transfer",
        slug: "FiltersTransfer",
       // i18n: "PowerbiAdmin",
      },
      {
        url: "/FiltersAllocation",
        name: "Filters - Allocation",
        slug: "FiltersAllocation",
       // i18n: "PowerbiAdmin",
      },
      {
        url: "/FilterGPSInformation",
        name: "Filters - GPS Info",
        slug: "FilterGPSInformation",
       // i18n: "PowerbiAdmin",
      },
      {
        url: "/DispensingTransfers",
        name: "Manual Entries",
        slug: "DispensingTransfers",
       // i18n: "PowerbiAdmin",
      },
    ]
  },
  {
    ...
    submenu: [
      {
        url: "/DataIntergrityChecks",
        name: "Data Ingerity Checks",
        slug: "DataIntergrityChecks",
       // i18n: "PowerbiAdmin",
      },
      {
        url: "/ExceptionHistory",
        name: "Exception History",
        slug: "ExceptionHistory",
      },
      {
        url: "/ReportHistory",
        name: "Report History",
  ...
  },
  {
    ...
    submenu: [
...

      {
        ...
        slug: "MasterEquipment",
        i18n: "MasterEquipment",
      },
...

  {
    ...
    submenu: [
      ...
      {
        url: "/UserContactInformation",
        name: "User Contact Info",
        slug: "UserContactInformation"
      },
  ...
  },
  {
    ...
    submenu: [
      ...
      //       slug: "StandardSetup",
      //       url: "/StandardReportAdminList",
      //      // i18n: "PowerbiAdmin",
      //     },
      //     {
      //       name: "Custom Report",
      //       slug: "CustomReportSetup",
      //       url: "/CustomReport",
      //     },
      //     {
      //       name: "System Report",
      //       slug: "SystemReportSetup",
      //       url: "/SystemReport",
      //     }
      //   ]
      // },
      ...
      // },
      {
        ...
        name: "Subscription",
        slug: "ManageSubscription",
      },
      {
        url: "/SubscriptionReport",
        name: "Subscription Report",
        slug: "SubscriptionReport",
      },
      {
        url: "/IntegrationSetup",
        name: "Integration Setup",
        slug: "IntegrationSetup",
      },
      {
        url: "/ManageIntegration",
        name: "Manage Integration",
        slug: "ManageIntegration",
      },
      {
        url: "/Diagnostic",
        name: "Diagnostic",
...
//       },
//       {
//         url: '/Customersitelist',
//         name: "Customersitelist",
//         slug: "Customersitelist",
//         i18n: "Customersitelist",
//       },
//     ]
//   },
//   {
...
//       },
//       {
//         url: "/DocumenttoCustomer",
//         name: "DocumenttoCustomer",
//         slug: "DocumenttoCustomer",
//         i18n: "DocumenttoCustomer",
//       },
//       {
//         url: "/DocumentCustomer",
//         name: "DocumentCustomer",
//         slug: "DocumentCustomer",
//         i18n: "DocumentCustomer",
//       },
//     ]
//   },
//   {
...
//       },
//       {
//         url: "/DailyReportofCall",
//         name: "DailyReportofCall",
//         slug: "DailyReportofCall",
//         i18n: "DailyReportofCall",
//       }
//     ]
//   },
...
//     slug: "quotationviewer",
//     icon: "EyeIcon",
//     i18n: "quotationviewer",
//   },
//   {
//     url: "/quotations",
//     name: "quotationlist",
...
//   },
  // {
  //   url: "/ui-elements/saleshunterquotation",
  //   name: "quotation",
  //   slug: "quotation",
  //   icon: "CoffeeIcon",
  //   i18n: "quotation",
