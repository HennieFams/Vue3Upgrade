export default {
  pages: {
    ...
    data: [
      // Sales
      //{ title: "Analytics Dashboard", url: "/dashboard/analytics", icon: "HomeIcon", is_bookmarked: true},
     // { title: "Accounts Select", url: "/selectaccount", icon: "UsersIcon", is_bookmarked: true },
      //{ title: "Products", url: "/products", icon: "PackageIcon", is_bookmarked: true },
      //{ title: "Customers", url: "/customers", icon: "SmileIcon", is_bookmarked: true },
      //{ title: "View Quotes", url: "/viewquotations", icon: "EyeIcon", is_bookmarked: true },
      //{ title: "Manage Quotessssss", url: "/quotations", icon: "ListIcon", is_bookmarked: true }
