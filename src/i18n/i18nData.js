...
export default {
	en: {
		...
		//********************/
		QuickDispense : 'QuickDispense',
		QuickDispense24 : 'QuickDispense24',
		QuickBalancing:'QuickBalancing',
		QuickDispenseSynfusion: 'QuickDispenseSynf',
		QuickCalendar: 'QuickCalendar',
		selectaccount :'selectaccount',
		Store:'Store Setup',
		StoreVPN:'Store VPN Setup',
		Tank:'Tank Setup',
		CostCentre: 'CostCentre Setup',
		MasterEquipment : 'Master Eqp Setup',
		PowerbiAdmin :'PowerbiAdmin',
		PBAnalytics: 'PBAnalytics',
		Allocation:'Allocation',
		Equipment : 'Equipment',
		F24Equipment :'EquipmentFAMS24',
		F24BusinessRules:'F24BusinessRules',
		Employee: 'Employee',
		F24Employee: 'EmployeeFAMS24',
		ReportsList :'Reports',
		UsersAdmin :'UsersAdmin',
	    ReportSetup :'ReportSetup',
		StandardSetup :'StandardSetup',
		SystemReportSetup :'SystemReportSetup',
		CustomReportSetup : 'CustomReportSetup',
		//***************** */
		account : 'Accounts',
		AccountSelect : 'AccountSelect',
		andrescratch : 'andrescratch',
		AccountCard :'AccountCard',
		product: 'Products',
		Documentlist: 'System Docs',
		DocumenttoCustomer: 'System 2 Cust',
		DocumentCustomer: 'Customer Docs',
    DailyReportofCall : 'Daily Report',
		IncidentReport: 'Incident / Call-Out',
		customers: 'Customer - Info',
		Customersitelist :'Customer - Site',
		quotation: 'Quotation (Create)',
		quotationviewer: 'View Quotations',
		quotationlist: 'Manage Quotations',
